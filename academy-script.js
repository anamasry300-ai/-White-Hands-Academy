...
<div class="img-c"><img src="\${photo('map')}" alt=""><div class="cap">🌍 رحلة البن من إثيوبيا إلى العالم</div></div>
...
<div class="img-c"><img src="\${photo('map')}" alt=""><div class="cap">🌍 Coffee's Journey from Ethiopia to the World</div></div>
...
<div class="img-c"><img src="\${photo('cherry')}" alt=""><div class="cap">🔬 تشريح ثمرة القهوة — 5 طبقات من البذرة إلى القشرة</div></div>
...
<div class="img-c"><img src="\${photo('cherry')}" alt=""><div class="cap">🔬 Coffee Cherry Anatomy — 5 Layers from Seed to Skin</div></div>
...
<div class="img-c"><img src="\${photo('water')}" alt=""><div class="cap">📊 قياس TDS — مفتاح الاتساق والجودة</div></div>
...
<div class="img-c"><img src="\${photo('water')}" alt=""><div class="cap">📊 TDS Measurement — Key to Consistency & Quality</div></div>
...
<div class="img-c"><img src="\${photo('v60')}" alt=""><div class="cap">🛠️ تحضير V60 خطوة بخطوة — من الغليان إلى التقديم</div></div>
...
<div class="img-c"><img src="\${photo('v60')}" alt=""><div class="cap">🛠️ V60 Step by Step — From Boil to Serve</div></div>
...
<div class="img-c"><img src="\${photo('espresso')}" alt=""><div class="cap">☕ الإسبريسو — 9 بار، 92°م، 30 ثانية</div></div>
...
<div class="img-c"><img src="\${photo('espresso')}" alt=""><div class="cap">☕ Espresso — 9 bar, 92°C, 30 seconds</div></div>
...
<div class="img-c"><img src="\${photo('latte')}" alt=""><div class="cap">🎨 أساسيات اللاتيه أرت — قلب، روزيتا، توليب</div></div>
...
<div class="img-c"><img src="\${photo('latte')}" alt=""><div class="cap">🎨 Latte Art Basics — Heart, Rosetta, Tulip</div></div>
...
<div class="img-c"><img src="\${photo('roast')}" alt=""><div class="cap">🔥 دورة التحميص — من الأخضر إلى الذهبي</div></div>
...
<div class="img-c"><img src="\${photo('roast')}" alt=""><div class="cap">🔥 Roasting Cycle — From Green to Golden</div></div>
...
<div class="img-c"><img src="\${photo('water')}" alt=""><div class="cap">💧 مراحل تنقية الماء — من الصنبور إلى الفنجان</div></div>
...
<div class="img-c"><img src="\${photo('water')}" alt=""><div class="cap">💧 Water Purification — From Tap to Cup</div></div>
...
<div class="img-c"><img src="\${photo('cupping')}" alt=""><div class="cap">🧪 محطة الكبينج — تقييم احترافي للقهوة</div></div>
...
<div class="img-c"><img src="\${photo('cupping')}" alt=""><div class="cap">🧪 Cupping Station — Professional Coffee Evaluation</div></div>
...
<div class="img-c"><img src="\${photo('cafe')}" alt=""><div class="cap">🏪 تصميم المقهى — تخطيط المساحة والعمل</div></div>
...
<div class="img-c"><img src="\${photo('cafe')}" alt=""><div class="cap">🏪 Cafe Design — Space & Workflow Planning</div></div>
...
<div class="img-c"><img src="\${photo('v60')}" alt=""><div class="cap">🧊 التحضير البارد — نكهة مختلفة، طريقة مختلفة</div></div>
...
<div class="img-c"><img src="\${photo('v60')}" alt=""><div class="cap">🧊 Cold Brew — Different Method, Different Flavor</div></div>
...
<div class="img-c"><img src="\${photo('espresso')}" alt=""><div class="cap">🔧 صيانة آلة الإسبريسو — يومية، أسبوعية، شهرية</div></div>
...
<div class="img-c"><img src="\${photo('espresso')}" alt=""><div class="cap">🔧 Espresso Machine Maintenance — Daily, Weekly, Monthly</div></div>
...
<div class="img-c"><img src="\${photo('roast')}" alt=""><div class="cap">🏭 معدات التحميص — من المحمصة اليدوية إلى التجارية</div></div>
...
<div class="img-c"><img src="\${photo('roast')}" alt=""><div class="cap">🏭 Roasting Equipment — From Hand to Commercial</div></div>
...
<div class="img-c"><img src="\${photo('water')}" alt=""><div class="cap">📊 عسر الماء — تأثيره على الاستخلاص والنكهة</div></div>
...
<div class="img-c"><img src="\${photo('water')}" alt=""><div class="cap">📊 Water Hardness — Its Effect on Extraction & Flavor</div></div>
...
<div class="img-c"><img src="\${photo('water')}" alt=""><div class="cap">🏭 تحضير الكميات — الاتساق في الإنتاج الكبير</div></div>
...
<div class="img-c"><img src="\${photo('water')}" alt=""><div class="cap">🏭 Batch Brew — Consistency in Volume Production</div></div>
...
<div class="img-c"><img src="\${photo('cupping')}" alt=""><div class="cap">👃 تدريب الحواس — كيف تصبح خبير تذوق</div></div>
...
<div class="img-c"><img src="\${photo('cupping')}" alt=""><div class="cap">👃 Sensory Training — How to Become a Tasting Expert</div></div>
