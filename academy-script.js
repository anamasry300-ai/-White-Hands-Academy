...
L['B1-3'] = {ar:`<h3>🔥 تحميص حسب المنشأ — لكل بن شخصيته</h3><p>كل منطقة منتجة للبن تحتاج <strong>منحنى تحميص مختلفاً</strong>. تحميص بن إثيوبي مثل تحميص بن برازيلي يؤدي إلى كارثة في الطعم. هذا هو الفرق بين المحمص العادي والمحمص المحترف.</p>
<h3>📊 تأثير الكثافة والرطوبة على منحنى التحميص</h3><p>عاملان فيزيائيان يحددان منحنى التحميص: الكثافة (Density) و نسبة الرطوبة (Moisture Content).<br>• البن عالي الكثافة (&gt;0.70 g/cm³) — مثل الإثيوبي والكيني — يحتاج طاقة حرارة أولية أعلى (Charge Temp 200-210°م).<br>• البن متوسط الكثافة (0.60-0.69 g/cm³) — مثل البرازيلي والكولومبي — Charge Temp 190-200°م.<br>• البن منخفض الكثافة (&lt;0.60 g/cm³) — مثل الإندونيسي — يحتاج طاقة حرارة أولية أقل (Charge Temp 180-190°م) — وإلا سيحترق السطح قبل نضج الداخل.</p>
<table><tr><th>المنشأ</th><th>الكثافة</th><th>Charge Temp</th><th>تحميص مثالي (Agtron)</th><th>النكهة المستهدفة</th></tr><tr><td>إثيوبيا / كينيا</td><td>عالية جداً (&gt;0.70)</td><td>200-210°م</td><td>فاتح (#75-85)</td><td>حموضة متألقة، زهري، فاكهي</td></tr><tr><td>كولومبيا / أمريكا الوسطى</td><td>عالية (0.65-0.70)</td><td>195-200°م</td><td>فاتح-متوسط (#65-75)</td><td>توازن، حلاوة، حموضة معتدلة</td></tr><tr><td>البرازيل / أمريكا الجنوبية</td><td>متوسطة (0.60-0.65)</td><td>185-195°م</td><td>متوسط (#55-65)</td><td>شوكولاتة، جوزي، قوام كامل</td></tr><tr><td>إندونيسيا / آسيا</td><td>منخفضة (&lt;0.60)</td><td>180-190°م</td><td>متوسط-داكن (#45-55)</td><td>ترابي، بهارات، قوام ثقيل</td></tr></table>
<h3>⏱️ زمن التطوير (Development Time Ratio — DTR)</h3><p>DTR = (زمن أول كراك إلى التبريد) / (إجمالي زمن التحميص) × 100. النسبة المثلى تختلف حسب المنشأ:<br>• إفريقي (عالية الكثافة): 18-22% — DTR أقصر للحفاظ على الحموضة والنكهات الزهرية<br>• أمريكا اللاتينية: 20-25% — DTR أطول قليلاً لتطوير الحلاوة<br>• آسيوي (منخفضة الكثافة): 22-28% — DTR الأطول لتطوير القوام وتحليل المركبات الثقيلة</p>
<h3>📚 المصادر العلمية</h3><p>• SCA Coffee Roasters Guild: "Roast Curve Analysis & Density Correlation"<br>• Rao, Scott (2014): "The Coffee Roaster's Companion" — الفصل 4: تأثير الكثافة على نقل الحرارة<br>• World Coffee Research: "Green Coffee Physical Properties" — كثافة البن 0.56 (سومطرة) إلى 0.78 (كينيا) جرام/سم³<br>• Agtron Roast Color Classification: SCA Development Time Standards — DTR 20-25% للتخصص</p>
<div class="info-box"><strong>💡 القاعدة الذهبية:</strong> البن عالي الكثافة (إثيوبي) يحتاج طاقة حرارة أعلى في بداية التحميص. البن منخفض الكثافة (إندونيسي) يحتاج طاقة أقل — وإلا سيحترق السطح قبل نضج الداخل. ادرس بنك قبل أن تحمصه!</div>`, en:`<h3>🔥 Origin-Specific Roasting — Every Bean Has Its Character</h3><p>Each coffee origin needs a <strong>different roast curve</strong>. Roasting Ethiopian like Brazilian leads to flavor disaster. This is the difference between average and professional roasters.</p>
<h3>📊 Density & Moisture Impact on Roast Curve</h3><p>Two physical factors determine the roast curve: Density and Moisture Content.<br>• High density (&gt;0.70 g/cm³) — Ethiopian & Kenyan — needs higher charge temp (200-210°C).<br>• Medium density (0.60-0.69 g/cm³) — Brazilian & Colombian — Charge Temp 190-200°C.<br>• Low density (&lt;0.60 g/cm³) — Indonesian — needs lower charge temp (180-190°C) — otherwise surface scorching.</p>
<table><tr><th>Origin</th><th>Density</th><th>Charge Temp</th><th>Ideal Roast (Agtron)</th><th>Target Flavor</th></tr><tr><td>Ethiopia / Kenya</td><td>Very high (&gt;0.70)</td><td>200-210°C</td><td>Light (#75-85)</td><td>Bright acidity, floral, fruity</td></tr><tr><td>Colombia / Central America</td><td>High (0.65-0.70)</td><td>195-200°C</td><td>Light-Med (#65-75)</td><td>Balance, sweetness, moderate acidity</td></tr><tr><td>Brazil / South America</td><td>Medium (0.60-0.65)</td><td>185-195°C</td><td>Medium (#55-65)</td><td>Chocolate, nutty, full body</td></tr><tr><td>Indonesia / Asia</td><td>Low (&lt;0.60)</td><td>180-190°C</td><td>Med-Dark (#45-55)</td><td>Earthy, spice, heavy body</td></tr></table>
<h3>⏱️ Development Time Ratio (DTR)</h3><p>DTR = (Time from First Crack to Cool) / (Total Roast Time) × 100. Ideal ratio by origin:<br>• African (high density): 18-22% — shorter DTR preserves acidity & floral notes<br>• Latin America: 20-25% — longer DTR for sweetness development<br>• Asian (low density): 22-28% — longest DTR for body development</p>
<h3>📚 Scientific References</h3><p>• SCA Coffee Roasters Guild — Roast Curve Analysis & Density Correlation<br>• Rao, Scott (2014): "The Coffee Roaster's Companion" — Ch.4: Density & Moisture Effects on Heat Transfer<br>• World Coffee Research — Green Coffee Physical Properties (0.56-0.78 g/cm³ range)<br>• Agtron Roast Color Classification — SCA Development Time Standards</p>
<div class="info-box"><strong>💡 Golden Rule:</strong> High-density beans (Ethiopia) need higher heat energy at roast start. Low-density beans (Indonesia) need less energy — otherwise the surface burns before the inside develops. Study your bean before roasting!</div>`};
...
L['B1-6'] = {ar:`<h3>🌍 أصول البن — إفريقيا مهد البن العربي</h3><p>إفريقيا هي <strong>موطن القهوة الأصلي</strong>. في غابات كافّا (Kaffa) بجنوب غرب إثيوبيا، لا تزال أشجار البن البرية تنمو طبيعياً تحت ظل الأشجار العملاقة. من هنا انطلقت القهوة إلى العالم. المنطقة الإفريقية تنتج أكثر أنواع البن <strong>تعقيداً ونقاوة</strong> في العالم.</p>
<div class="img-c"><img src="${photo('ethiopian')}" alt="" loading="lazy"><div class="cap">📸 مزرعة بن إثيوبية — غابات البن البرية في كافّا</div></div>
<h3>🇪🇹 إثيوبيا — مهد القهوة</h3><p>إثيوبيا هي <strong>المنشأ الوحيد</strong> للبن الأرابيكا (Coffea arabica) في الطبيعة. تنتج أكثر من <strong>500,000 طن</strong> سنوياً — خامس أكبر منتج عالمي. أشهر المناطق: <strong>ييرغاتشيفي (Yirgacheffe)</strong> — نكهات زهرية وياسمين وحمضيات حادة; <strong>سيدامو (Sidamo)</strong> — توت بري وليمون وزبدة; <strong>غوجي (Guji)</strong> — خوخ وزهر البرتقال وشاي أحمر. الأصناف (Varieties): أصناف تقليدية وراثية (Heirloom) — أكثر من 10,000 نوع مختلف — معظمها غير مصنف علمياً. الارتفاع: 1,500-2,200 متر. المعالجة السائدة: <strong>مغسولة (Washed)</strong> في الجنوب — نظيفة وزهرية; <strong>طبيعية (Natural)</strong> في الشرق (هرار) — فاكهية ومخمرة.</p>
<h3>🇰🇪 كينيا — الحموضة المتألقة</h3><p>كينيا تشتهر بأعلى <strong>حموضة متألقة (Bright Acidity)</strong> في عالم القهوة — نكهات الكشمش الأسود والطماطم الخضراء والكرمب فروت. الأصناف الشهيرة: <strong>SL28</strong> (طورته سكوت لاب في 1930s) — نكهات التوت والليمون; <strong>SL34</strong> — نفحات الطماطم والتوابل; <strong>رويرو 11 (Ruiru 11)</strong> — مقاوم للأمراض لكن أقل تعقيداً. المعالجة الكينية الفريدة: <strong>التخمير المزدوج (Double Fermentation)</strong> — تخمير جاف 24 ساعة ← تخمير مائي 24 ساعة ← غسيل نهائي. هذا يعطي القهوة نقاوتها الاستثنائية. التحميص الأمثل: <strong>فاتح (Light)</strong> (Agtron #75-85) — حرارة بدء عالية 200-210°م لأن الكثافة عالية جداً. زمن التطوير: 18-22% من إجمالي الوقت.</p>
<h3>🇷🇼 رواندا و🇧🇮 بوروندي — نهضة القهوة</h3><p>بعد الإبادة الجماعية في رواندا (1994)، استثمرت الدولة في <strong>القهوة كأداة للتعافي الاقتصادي</strong>. اليوم رواندا تنتج بعضاً من أنقى أنواع الأرابيكا في إفريقيا. الأصناف: <strong>بوربون (Bourbon)</strong> — الفصيل الرئيسي المزروع في البحيرات العظمى. النكهات: عنب أحمر، عنبية، سكر بني، قوام زبدة. الارتفاع: 1,500-2,000 متر. المعالجة: 95% <strong>مغسولة</strong> — بسبب وفرة المياه من البحيرات (بحيرة كيفو). التحميص الأمثل: <strong>فاتح-متوسط (Light-Med)</strong> (Agtron #65-75) — حرارة بدء 195-200°م; زمن تطوير 20-23%.</p>
<div class="info-box"><strong>📚 المصادر:</strong> World Coffee Research (WCR) — Sensory Lexicon & Variety Catalog; SCA Coffee Roasters Guild — Origin Roasting Guides; KENYA Coffee & Tea Authority — SL Varieties Origin; Rwanda Coffee Board (NAEB) — Washing Station Data.</div>
<div class="ok-box"><strong>🎯 تمرين:</strong> اشتر 3 أنواع بن إفريقي من مناشئ مختلفة (إثيوبيا ييرغاتشيفي مغسول، كينيا SL28، رواندا بوربون). حمّصها بنفس المنحنى (Light). تذوق الفرق في الحموضة والنكهات. سجل النتائج.</div>`, en:`<h3>🌍 Coffee Origins — Africa, the Birthplace of Arabica</h3><p>Africa is the <strong>original home of coffee</strong>. In the Kaffa forests of southwestern Ethiopia, wild coffee trees still grow naturally under the canopy of giant forest trees. From here coffee spread to the world. The African region produces some of the most <strong>complex and cleanest</strong> coffees on earth.</p>
<div class="img-c"><img src="${photo('ethiopian')}" alt="" loading="lazy"><div class="cap">📸 Ethiopian coffee farm — Wild coffee forests in Kaffa</div></div>
<h3>🇪🇹 Ethiopia — Birthplace of Coffee</h3><p>Ethiopia is the <strong>only origin</strong> where Arabica (Coffea arabica) grows wild in nature. It produces over <strong>500,000 tons</strong> annually — 5th largest global producer. Famous regions: <strong>Yirgacheffe</strong> — floral, jasmine, intense citrus; <strong>Sidamo</strong> — berry, lemon, buttery; <strong>Guji</strong> — peach, orange blossom, red tea. Varieties: <strong>Heirloom</strong> — over 10,000 genetically distinct types, most unclassified. Elevation: 1,500-2,200m. Dominant processing: <strong>Washed</strong> in the south — clean & floral; <strong>Natural</strong> in the east (Harar) — fruity & fermented.</p>
<h3>🇰🇪 Kenya — The Bright Acidity King</h3><p>Kenya is famous for the highest <strong>bright acidity</strong> in the coffee world — blackcurrant, green tomato, grapefruit flavors. Famous varieties: <strong>SL28</strong> (Scott Labs, 1930s) — berry & lemon notes; <strong>SL34</strong> — tomato & spice hints; <strong>Ruiru 11</strong> — disease resistant but less complex. Unique Kenyan processing: <strong>Double Fermentation</strong> — dry ferment 24h → wet ferment 24h → final wash. This gives exceptional clarity. Optimal roast: <strong>Light</strong> (Agtron #75-85) — high charge temp 200-210°C due to very high density. Development time: 18-22%.</p>
<h3>🇷🇼 Rwanda & 🇧🇮 Burundi — Coffee Renaissance</h3><p>After the Rwandan genocide (1994), the country invested in <strong>coffee as an economic recovery tool</strong>. Today Rwanda produces some of the cleanest Arabica in Africa. Varieties: <strong>Bourbon</strong> — the main cultivar in the Great Lakes region. Flavors: red grape, blueberry, brown sugar, buttery body. Elevation: 1,500-2,000m. Processing: 95% <strong>Washed</strong> — abundant water from the lakes (Lake Kivu). Optimal roast: <strong>Light-Med</strong> (Agtron #65-75) — charge temp 195-200°C; DTR 20-23%.</p>
<div class="info-box"><strong>📚 Sources:</strong> World Coffee Research (WCR) — Sensory Lexicon & Variety Catalog; SCA Coffee Roasters Guild — Origin Roasting Guides; Kenya Coffee & Tea Authority — SL Varieties Origin; Rwanda Coffee Board (NAEB) — Washing Station Data.</div>
<div class="ok-box"><strong>🎯 Exercise:</strong> Buy 3 African coffees from different origins (Ethiopia Yirgacheffe washed, Kenya SL28, Rwanda Bourbon). Roast them using the same curve (Light). Taste the difference in acidity and flavor notes. Record your findings.</div>`};

L['B1-7'] = {ar:`<h3>🌎 أصول البن — أمريكا اللاتينية سلة Specialty</h3><p>أمريكا اللاتينية تنتج <strong>أكثر من 60%</strong> من بن الأرابيكا في العالم. تشتهر المنطقة بالتوازن والحلاوة والنكهات النظيفة — مثالية للمبتدئين والمحترفين على حد سواء. تنوع المناخ والارتفاع والتربة يخلق نكهات مختلفة من الشوكولاتة الثقيلة إلى الحمضيات الزهرية.</p>
<div class="img-c"><img src="${photo('coffee_map')}" alt="" loading="lazy"><div class="cap">📍 الدول المنتجة في أمريكا اللاتينية — من كولومبيا إلى البرازيل</div></div>
<h3>🇨🇴 كولومبيا — أيقونة الجودة</h3><p>كولومبيا ثالث أكبر منتج أرابيكا في العالم. تشتهر <strong>بالجودة المستقرة</strong> — بن متوازن، حلاوة كراميل، حموضة معتدلة، قوام متوسط. المناطق: <strong>هويلا (Huila)</strong> — حلاوة فواكه; <strong>نارينيو (Nariño)</strong> — حموضة زهرية; <strong>أنتيوكيا (Antioquia)</strong> — شوكولاتة وجوز. يشتهر الكولومبي بمعالجته <strong>المغسولة (Washed)</strong> التي تبرز نقاوة البن. التحميص الأمثل: <strong>فاتح-متوسط (Light-Med)</strong> (Agtron #65-75) — حرارة بدء 195-200°م. زمن التطوير: 20-25%. كثافة البن متوسطة-عالية.</p>
<h3>🇧🇷 البرازيل — عملاق الإنتاج</h3><p>البرازيل هي <strong>أكبر منتج ومصدر للبن في العالم</strong> — أكثر من 3.7 مليون طن سنوياً. تشتهر بالبن ذو <strong>القوام الكامل (Full Body)</strong>، نكهات الشوكولاتة والفول السوداني، وحموضة منخفضة. بسبب المسطحات المنخفضة (700-1,300 متر)، البن البرازيلي أقل كثافة. المعالجات: <strong>الطبيعية (Natural)</strong> رائدة — البرازيل تنتج أفضل بن طبيعي في العالم; <strong>المعالجة باللب (Pulped Natural)</strong> — اختراع برازيلي: نزع القشرة مع ترك اللب. التحميص الأمثل: <strong>متوسط (Medium)</strong> (Agtron #55-65) — حرارة بدء 185-195°م. زمن التطوير 22-27% لتعزيز الحلاوة.</p>
<h3>🇨🇷 كوستاريكا — جودة وهاني</h3><p>كوستاريكا أول دولة في أمريكا الوسطى تمنع قانونياً زراعة روبوستا — 100% أرابيكا. تشتهر <strong>بمعالجة العسل (Honey Processing)</strong> بجميع ألوانها: الأصفر (أقل لب)— الأخف; الأحمر (نصف لب)— توازن; الأسود (أقصى لب)— الأكثر حلاوة. منطقتها الأشهر: <strong>تارازو (Tarrazú)</strong> — نكهات تفاح أخضر، ليمون، وكراميل. التحميص الأمثل: <strong>فاتح-متوسط (Agtron #65-75)</strong> — حرارة بدء 195°م.</p>
<h3>🇬🇹 غواتيمالا — terroir بركاني</h3><p>التربة البركانية الخصبة تعطي القهوة <strong>نكهات معقدة</strong>. مناطق متميزة: <strong>أنتيغوا (Antigua)</strong> — شوكولاتة وتوابل; <strong>هويهويتنانغو (Huehuetenango)</strong> — فواكه استوائية وأزهار. التحميص الأمثل: <strong>متوسط (Medium)</strong> (Agtron #55-65).</p>
<h3>🇵🇦 بنما — ظاهرة الجيشا</h3><p>بنما اشتهرت عالمياً بسبب <strong>صنف الجيشا (Geisha/Gesha)</strong> — أغلى قهوة في العالم (تصل لـ $2,000/كجم في المزادات). في مقاطعة تشيريكي (Chiriquí) على ارتفاع 1,600-1,800 متر. النكهات: الياسمين، الشاي الأسود، المانجو، النقاء الزجاجي. التحميص: <strong>فاتح جداً</strong> (Agtron #85-95) — للحفاظ على النكهات الرقيقة.</p>
<div class="info-box"><strong>📚 المصادر:</strong> ICA (International Coffee Organization) — Coffee Yearbook; SCAA (Specialty Coffee Association of America) — Green Coffee Classification; FNC (Federación Nacional de Cafeteros de Colombia) — Variety Guide; World Coffee Research — Latin American Trials.</div>
<div class="ok-box"><strong>🎯 تمرين:</strong> اشتر بن كولومبي من مناطق مختلفة (هويلا ونارينيو). حمّص نفس المنحنى. تذوق فرق الحموضة (نارينيو أكثر زهرية) والحلاوة (هويلا أكثر فواكه).</div>`, en:`<h3>🌎 Coffee Origins — Latin America, the Specialty Basket</h3><p>Latin America produces <strong>over 60%</strong> of the world's Arabica coffee. The region is famous for balance, sweetness, and clean flavors — ideal for both beginners and professionals. Diverse climate, altitude, and soil create flavors ranging from heavy chocolate to floral citrus.</p>
<div class="img-c"><img src="${photo('coffee_map')}" alt="" loading="lazy"><div class="cap">📍 Producing countries in Latin America — from Colombia to Brazil</div></div>
<h3>🇨🇴 Colombia — The Quality Icon</h3><p>Colombia is the 3rd largest Arabica producer. Famous for <strong>consistent quality</strong> — balanced, caramel sweetness, moderate acidity, medium body. Regions: <strong>Huila</strong> — fruity sweetness; <strong>Nariño</strong> — floral acidity; <strong>Antioquia</strong> — chocolate & nut. Dominant process: <strong>Washed</strong> — highlights clarity. Optimal roast: <strong>Light-Med</strong> (Agtron #65-75) — charge temp 195-200°C. DTR: 20-25%. Medium-high density.</p>
<h3>🇧🇷 Brazil — The Production Giant</h3><p>Brazil is the <strong>world's largest coffee producer and exporter</strong> — over 3.7 million tons annually. Famous for <strong>full body</strong>, chocolate and peanut flavors, and low acidity. Due to lower altitudes (700-1,300m), Brazilian beans are less dense. Processes: <strong>Natural</strong> — Brazil produces the world's best naturals; <strong>Pulped Natural</strong> — a Brazilian invention: remove skin while leaving mucilage. Optimal roast: <strong>Medium</strong> (Agtron #55-65) — charge temp 185-195°C. DTR 22-27% to enhance sweetness.</p>
<h3>🇨🇷 Costa Rica — Quality & Honey</h3><p>Costa Rica was the first Central American country to legally ban Robusta — 100% Arabica. Famous for <strong>Honey Processing</strong> in all colors: Yellow (least mucilage) — lightest; Red (half mucilage) — balanced; Black (maximum mucilage) — sweetest. Premier region: <strong>Tarrazú</strong> — green apple, lemon, caramel. Optimal roast: <strong>Light-Med</strong> (Agtron #65-75) — charge temp 195°C.</p>
<h3>🇬🇹 Guatemala — Volcanic Terroir</h3><p>Fertile volcanic soil gives <strong>complex flavors</strong>. Distinct regions: <strong>Antigua</strong> — chocolate & spice; <strong>Huehuetenango</strong> — tropical fruits & flowers. Optimal roast: <strong>Medium</strong> (Agtron #55-65).</p>
<h3>🇵🇦 Panama — The Geisha Phenomenon</h3><p>Panama became world-famous for <strong>Geisha (Gesha)</strong> — the world's most expensive coffee (up to $2,000/kg at auction). From Chiriquí province at 1,600-1,800m. Flavors: jasmine, black tea, mango, glass-like clarity. Roast: <strong>Very Light</strong> (Agtron #85-95) — to preserve delicate flavors.</p>
<div class="info-box"><strong>📚 Sources:</strong> ICO (International Coffee Organization) — Coffee Yearbook; SCAA — Green Coffee Classification; FNC (Federación Nacional de Cafeteros de Colombia) — Variety Guide; World Coffee Research — Latin American Trials.</div>
<div class="ok-box"><strong>🎯 Exercise:</strong> Buy Colombian coffee from different regions (Huila and Nariño). Roast with the same profile. Compare acidity (Nariño more floral) and sweetness (Huila more fruity).</div>`};

L['B1-8'] = {ar:`<h3>🌏 أصول البن — آسيا نكهات ترابية وقهوة غامضة</h3><p>آسيا تنتج بعضاً من <strong>أغرب وأعقد أنواع البن</strong> في العالم. هنا لا تهيمن الحموضة — بل <strong>القوام الثقيل والنكهات الترابية والتوابل</strong>. المنطقة معروفة بتقنيات معالجة فريدة تختلف عن أي مكان آخر في العالم.</p>
<div class="img-c"><img src="${photo('coffee_map')}" alt="" loading="lazy"><div class="cap">🗺️ الدول المنتجة في آسيا — من اليمن إلى فيتنام</div></div>
<h3>🇾🇪 اليمن — القهوة الأولى في التجارة</h3><p>اليمن هي <strong>أول دولة صدرت البن تجارياً</strong> في التاريخ. من ميناء <strong>المخا (Mocha/Mokha)</strong> — الميناء التاريخي الذي أعطى اسمه للقهوة بالشوكولاتة — انطلقت القهوة إلى العالم في القرن الخامس عشر. مازالت اليمن تزرع البن <strong>بطريقة تقليدية جافة</strong> — بدون ري صناعي، على مصاطب جبلية في 1,500-2,400 متر. الأصناف: <strong>قديم (Heirloom/Turabi)</strong> — أصناف وراثية يمنية غير مصنفة. النكهات: معقدة جداً — نبيذية (Winey)، توابل (هيل وقرفة)، شوكولاتة داكنة، فواكه مجففة، دخان خفيف. التحميص الأمثل: <strong>متوسط (Medium)</strong> (Agtron #55-65) — لإبراز النكهات المعقدة دون حرق الحموضة الدقيقة. كثافة متوسطة. حرارة بدء 190-195°م.</p>
<h3>🇮🇩 إندونيسيا — العمالقة الخضراء</h3><p>إندونيسيا رابع أكبر منتج بن في العالم — <strong>660,000 طن</strong> سنوياً. تشتهر بالنكهات الترابية والأعشاب و<strong>القوام الثقيل جداً (Very Heavy Body)</strong> — مثالية للإسبريسو. المناطق الرئيسية: <strong>سومطرة (Sumatra)</strong> — الأكثر شهرة: نكهات ترابية، تبغ، أرز، فلفل أسود; <strong>جاوة (Java)</strong> — أخف قليلاً: توابل وخشب; <strong>سولاويسي (Sulawesi / Celebes)</strong> — نكهات فواكه استوائية أكثر. المعالجة الفريدة: <strong>جيليلينغ باساه (Giling Basah / Wet-Hulled)</strong> — تنزع قشرة البن وهو رطب بنسبة رطوبة 30-40% (بدلاً من 10-12%). هذا يخلق نكهاتها الترابية الفريدة. التحميص الأمثل: <strong>متوسط-داكن (Medium-Dark)</strong> (Agtron #45-55) — لأن الكثافة منخفضة جداً. حرارة بدء منخفضة 180-190°م لتجنب حرق السطح. زمن تطوير 22-28% لتطوير القوام.</p>
<h3>🇮🇳 الهند — القهوة المنسونية</h3><p>الهند تنتج قهوة فريدة تسمى <strong>مونسونيد مالابار (Monsooned Malabar)</strong> — وهي قهوة تتعرض عمداً للرياح الموسونية (Monsoon winds) لمدة 12-16 أسبوعاً في مستودعات مفتوحة. النتيجة: <strong>حموضة منخفضة جداً، قوام كامل، نكهات خشب وجلود وتوابل</strong>. مناطق: تشيكماغالور (Chikmagalur) — 1,200-1,500 متر. البن المنسوني شبه منعدم الحموضة — وهذه ميزته.</p>
<h3>🇻🇳 فيتنام — إمبراطورية الروبوستا</h3><p>فيتنام هي <strong>ثاني أكبر منتج بن في العالم</strong> — لكنها تسيطر على إنتاج <strong>الروبوستا</strong> (أكثر من 40% من الإنتاج العالمي). تزرع القهوة على ارتفاعات منخفضة (300-800 متر). نكهات: شوكولاتة مرة، جوز، حبوب محمصة، حموضة معدومة. نسبة الكافيين: 2.2-2.7%. التحميص الأمثل: <strong>غامق (Dark)</strong> (Agtron #25-45) — فيتنام تحمص مع الزبدة والكاكاو (Tradition Roast).</p>
<div class="info-box"><strong>📚 المصادر:</strong> ICO — Coffee Development Reports: Asia; World Coffee Research — Indonesia Country Profile; Coffee Quality Institute — Monsooned Malabar Guide; ASEAN Coffee Federation — Vietnam Robusta Data.</div>
<div class="err-box"><strong>⚠️ تحذير:</strong> البن الإندونيسي أكثر قابلية للحرق (Scorching) بسبب كثافته المنخفضة. خفف طاقة التحميص في أول 3 دقائق. البن اليمني يحتاج 24 ساعة راحة (Rest) على الأقل بعد التحميص قبل التذوق — نكهاته تتطور كثيراً مع الوقت.</div>
<div class="ok-box"><strong>🎯 تمرين:</strong> اشتر بن سومطري (Giling Basah) وبن يمني. حمّصها بنفس المنحنى المتوسط. قارن الفرق في النكهة — الترابي والتوابل في السومطري مقابل النبيذي والمعقد في اليمني.</div>`, en:`<h3>🌏 Coffee Origins — Asia, Earthy Flavors & Mysterious Coffees</h3><p>Asia produces some of the <strong>strangest and most complex coffees</strong> in the world. Here acidity does not dominate — instead <strong>heavy body, earthy, and spice notes</strong> reign. The region is known for unique processing techniques found nowhere else.</p>
<div class="img-c"><img src="${photo('coffee_map')}" alt="" loading="lazy"><div class="cap">🗺️ Producing countries in Asia — from Yemen to Vietnam</div></div>
<h3>🇾🇪 Yemen — The First Coffee Trader</h3><p>Yemen was <strong>the first country to commercially export coffee</strong> in history. From the port of <strong>Mocha (Mokha)</strong> — the historic port that gave its name to chocolate coffee — coffee spread to the world in the 15th century. Yemen still grows coffee <strong>traditionally dry-farmed</strong> — no irrigation, on mountain terraces at 1,500-2,400m. Varieties: <strong>Heirloom (Turabi)</strong> — unclassified Yemeni heirloom types. Flavors: extremely complex — winey, spices (cardamom, cinnamon), dark chocolate, dried fruit, light smoke. Optimal roast: <strong>Medium</strong> (Agtron #55-65) — to highlight complexity without burning delicate acidity. Medium density. Charge temp 190-195°C.</p>
<h3>🇮🇩 Indonesia — The Green Giants</h3><p>Indonesia is the 4th largest coffee producer — <strong>660,000 tons</strong> annually. Famous for earthy, herbal flavors and <strong>very heavy body</strong> — ideal for espresso. Key regions: <strong>Sumatra</strong> — most famous: earthy, tobacco, rice, black pepper; <strong>Java</strong> — lighter: spice & wood; <strong>Sulawesi (Celebes)</strong> — more tropical fruit notes. Unique processing: <strong>Giling Basah (Wet-Hulled)</strong> — hull is removed while beans are still at 30-40% moisture (instead of 10-12%). This creates the unique earthy flavor. Optimal roast: <strong>Medium-Dark</strong> (Agtron #45-55) — very low density. Low charge temp 180-190°C to avoid scorching the surface. DTR 22-28% for body development.</p>
<h3>🇮🇳 India — The Monsooned Malabar</h3><p>India produces a unique coffee called <strong>Monsooned Malabar</strong> — intentionally exposed to monsoon winds for 12-16 weeks in open warehouses. Result: <strong>very low acidity, full body, wood, leather, and spice flavors</strong>. Regions: Chikmagalur — 1,200-1,500m. Monsooned coffee is nearly acid-free — and that's its selling point.</p>
<h3>🇻🇳 Vietnam — The Robusta Empire</h3><p>Vietnam is the <strong>2nd largest coffee producer in the world</strong> — but dominates <strong>Robusta</strong> production (over 40% of global Robusta). Grown at low altitudes (300-800m). Flavors: bitter chocolate, nuts, roasted grain, zero acidity. Caffeine: 2.2-2.7%. Optimal roast: <strong>Dark</strong> (Agtron #25-45) — Vietnam roasts with butter and cocoa (Tradition Roast).</p>
<div class="info-box"><strong>📚 Sources:</strong> ICO — Coffee Development Reports: Asia; World Coffee Research — Indonesia Country Profile; Coffee Quality Institute — Monsooned Malabar Guide; ASEAN Coffee Federation — Vietnam Robusta Data.</div>
<div class="err-box"><strong>⚠️ Warning:</strong> Indonesian beans scorch easily due to low density. Reduce heat energy in the first 3 minutes. Yemeni beans need 24 hours rest after roasting before tasting — flavors develop significantly with time.</div>
<div class="ok-box"><strong>🎯 Exercise:</strong> Buy Sumatran (Giling Basah) and Yemeni coffee. Roast both with the same medium profile. Compare the flavor difference — earthy & spice in Sumatra vs winey & complex in Yemen.</div>`};
...
qz('B1-6','💬 في أي دولة تقع غابات كافّا — الموطن الأصلي للبن الأرابيكا؟ (الإجابة: إثيوبيا)','💬 In which country are the Kaffa forests — the original home of Arabica coffee? (Answer: Ethiopia)');
qz('B1-7','💬 أي دولة تمنع قانونياً زراعة روبوستا وتشتهر بمعالجة العسل؟ (الإجابة: كوستاريكا)','💬 Which country legally bans Robusta farming and is famous for honey processing? (Answer: Costa Rica)');
qz('B1-8','💬 ما اسم المعالجة الفريدة في إندونيسيا التي تنزع القشرة عند رطوبة 30-40%؟ (الإجابة: Giling Basah — Wet-Hulled)','💬 What is the unique Indonesian processing method that removes the hull at 30-40% moisture? (Answer: Giling Basah — Wet-Hulled)');
...
{id:'B1',level:'B',title:{ar:'أسرار التحميص',en:'Roasting Secrets'},icon:'🔥',desc:{ar:'من الأخضر إلى المحمص',en:'Green to Brown'},img:imgPath('B1'),lessons:[
    ...
    {title:{ar:'أصول البن — إفريقيا',en:'Coffee Origins — Africa'},img:imgPath('coffee_map')},
    {title:{ar:'أصول البن — أمريكا اللاتينية',en:'Coffee Origins — Latin America'},img:imgPath('coffee_map')},
    {title:{ar:'أصول البن — آسيا',en:'Coffee Origins — Asia'},img:imgPath('coffee_map')}
]},
