...
/* ===== SVG Illustrations ===== */
const SVG={};
function svg(id){return'data:image/svg+xml,'+encodeURIComponent((SVG[id]||'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 400"><rect width="800" height="400" fill="#1a1a2e"/><text x="400" y="200" text-anchor="middle" fill="#c9a84c" font-size="20" font-family="sans-serif">'+id+'</text></svg>').replace(/>\s+</g,'><'))}
function bgSVG(c1,c2,ic){let paths={ar:'☕',en:'💧',ro:'🔥',co:'🌱',cu:'👃',pr:'🫘',ca:'🏪',jo:'🌍'};let p=paths[ic]||ic||'☕';let s='<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 400"><defs><linearGradient id="gbg" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stop-color="'+(c1||'#1a1a2e')+'"/><stop offset="100%" stop-color="'+(c2||'#2d2d44')+'"/></linearGradient><radialGradient id="gglow" cx="50%" cy="40%" r="50%"><stop offset="0%" stop-color="#c9a84c" stop-opacity=".12"/><stop offset="100%" stop-color="#c9a84c" stop-opacity="0"/></radialGradient></defs><rect width="800" height="400" fill="url(#gbg)"/><circle cx="400" cy="160" r="200" fill="url(#gglow)"/><g stroke="#c9a84c" fill="none" opacity=".08"><circle cx="400" cy="200" r="140"/><circle cx="400" cy="200" r="115"/><circle cx="400" cy="200" r="90"/></g><g stroke="#c9a84c" fill="none" opacity=".035"><line x1="50" y1="30" x2="120" y2="30"/><line x1="50" y1="30" x2="50" y2="80"/><line x1="750" y1="30" x2="680" y2="30"/><line x1="750" y1="30" x2="750" y2="80"/><line x1="50" y1="370" x2="120" y2="370"/><line x1="50" y1="370" x2="50" y2="320"/><line x1="750" y1="370" x2="680" y2="370"/><line x1="750" y1="370" x2="750" y2="320"/></g><text x="400" y="230" text-anchor="middle" fill="#c9a84c" font-size="96" opacity=".18" font-family="Arial,Helvetica,sans-serif">'+(ic||'☕')+'</text><text x="400" y="228" text-anchor="middle" fill="#c9a84c" font-size="96" opacity=".06" font-family="Arial,Helvetica,sans-serif">'+(ic||'☕')+'</text></svg>';return'data:image/svg+xml,'+encodeURIComponent(s)}
...
const LOCAL_IMGS=new Set(['A0','A1','A2','A3','barista','beans','cafe','cherry','coldbrew','cupping','espresso','journey','latte','map','roast','team','v60','water']);
...
function photo(key){return imgPath(key,1400,85)}
function photoSmall(key){return imgPath(key,600,80)}


// A1 — Kaldi with goats and coffee tree
SVG.A1=`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 400"><defs><linearGradient id="s1" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stop-color="#3d1c00"/><stop offset="100%" stop-color="#1a1a2e"/></linearGradient><linearGradient id="h1" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stop-color="#2d5a27" stop-opacity=".7"/><stop offset="100%" stop-color="#1a3a1a" stop-opacity=".5"/></linearGradient></defs><rect width="800" height="400" fill="url(#s1)"/><path d="M0 270Q150 180 300 250Q450 160 600 230Q700 185 800 250v150H0Z" fill="url(#h1)"/><path d="M0 300Q200 250 350 280Q500 230 800 280v120H0Z" fill="#1a3a1a" opacity=".6"/><g stroke="#c9a84c" fill="none" opacity=".12"><circle cx="120" cy="70" r="25"/><circle cx="120" cy="70" r="35"/><line x1="120" y1="35" x2="120" y2="20"/><line x1="120" y1="105" x2="120" y2="120"/><line x1="85" y1="70" x2="70" y2="70"/><line x1="155" y1="70" x2="170" y2="70"/></g><line x1="560" y1="340" x2="560" y2="170" stroke="#5a3a1a" stroke-width="5" stroke-linecap="round"/><line x1="560" y1="220" x2="510" y2="180" stroke="#5a3a1a" stroke-width="3" stroke-linecap="round"/><line x1="560" y1="240" x2="610" y2="200" stroke="#5a3a1a" stroke-width="3" stroke-linecap="round"/><circle cx="510" cy="175" r="22" fill="none" stroke="#3a7a33" stroke-width="2.5"/><circle cx="610" cy="195" r="22" fill="none" stroke="#3a7a33" stroke-width="2.5"/><circle cx="560" cy="160" r="26" fill="none" stroke="#3a7a33" stroke-width="2.5"/><circle cx="555" cy="165" r="4" fill="#cc3333"/><circle cx="570" cy="158" r="4" fill="#cc3333"/><circle cx="505" cy="177" r="4" fill="#cc3333"/><circle cx="605" cy="197" r="4" fill="#cc3333"/><circle cx="615" cy="190" r="4" fill="#cc3333"/><circle cx="520" cy="168" r="4" fill="#cc3333"/><g stroke="#f5f0e6" stroke-linecap="round"><line x1="200" y1="270" x2="200" y2="325" stroke-width="4"/><circle cx="200" cy="258" r="12" fill="none" stroke-width="2.5"/><line x1="200" y1="287" x2="175" y2="307" stroke-width="3"/><line x1="200" y1="287" x2="225" y2="275" stroke-width="3"/><line x1="200" y1="325" x2="185" y2="358" stroke-width="3"/><line x1="200" y1="325" x2="215" y2="358" stroke-width="3"/></g><line x1="225" y1="260" x2="240" y2="365" stroke="#8B6914" stroke-width="3" stroke-linecap="round"/><g stroke="#e8d5c4" fill="none"><ellipse cx="310" cy="320" rx="22" ry="12" stroke-width="3"/><ellipse cx="335" cy="310" rx="10" ry="7" stroke-width="2.5"/><line x1="295" y1="330" x2="290" y2="358" stroke-width="2.5"/><line x1="325" y1="330" x2="320" y2="358" stroke-width="2.5"/><path d="M332 305Q328 295 335 290" stroke-width="2"/></g><g stroke="#d4bfa0" fill="none"><ellipse cx="370" cy="338" rx="18" ry="10" stroke-width="2.5"/><line x1="358" y1="346" x2="354" y2="365" stroke-width="2"/><line x1="382" y1="346" x2="378" y2="365" stroke-width="2"/></g><line x1="0" y1="368" x2="800" y2="368" stroke="#c9a84c" stroke-width=".5" opacity=".3"/><text x="400" y="45" text-anchor="middle" fill="#c9a84c" font-size="26" font-family="serif" font-weight="bold">أسطورة كلد</text><text x="400" y="68" text-anchor="middle" fill="#f5f0e6" font-size="14" opacity=".6" font-family="sans-serif">Kaldi &amp; His Goats — Ethiopian Highlands, 850 AD</text></svg>`;

// A2 — Yemeni Ibrik / traditional coffee pot (detailed)
SVG.A2=`<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 800 400'><defs><linearGradient id='s2bg' x1='0%' y1='0%' x2='100%' y2='100%'><stop offset='0%' stop-color='#3d1c00'/><stop offset='100%' stop-color='#1a1a2e'/></linearGradient><linearGradient id='copper' x1='0%' y1='0%' x2='100%' y2='100%'><stop offset='0%' stop-color='#e8c070'/><stop offset='30%' stop-color='#d4a85a'/><stop offset='60%' stop-color='#c9a84c'/><stop offset='100%' stop-color='#8b6914'/></linearGradient><linearGradient id='gold' x1='0%' y1='0%' x2='100%' y2='200%'><stop offset='0%' stop-color='#f0d080'/><stop offset='100%' stop-color='#c9a84c'/></linearGradient><linearGradient id='steam' x1='0%' y1='100%' x2='0%' y2='0%'><stop offset='0%' stop-color='#fff' stop-opacity='0.3'/><stop offset='100%' stop-color='#fff' stop-opacity='0'/></linearGradient><linearGradient id='lid' x1='0%' y1='0%' x2='0%' y2='100%'><stop offset='0%' stop-color='#e8c070'/><stop offset='100%' stop-color='#b8860b'/></linearGradient></defs><rect width='800' height='400' fill='url(#s2bg)'/><circle cx='100' cy='70' r='30' fill='none' stroke='#c9a84c' stroke-width='1' opacity='0.12'/><circle cx='100' cy='70' r='20' fill='none' stroke='#c9a84c' stroke-width='1.5' opacity='0.12'/><circle cx='700' cy='90' r='35' fill='none' stroke='#c9a84c' stroke-width='1' opacity='0.12'/><circle cx='700' cy='90' r='25' fill='none' stroke='#c9a84c' stroke-width='1.5' opacity='0.12'/><text x='400' y='45' text-anchor='middle' fill='#c9a84c' font-size='24' font-family='Arial'>أول فنجان قهوة</text><text x='400' y='65' text-anchor='middle' fill='#d4a85a' font-size='11' font-family='Georgia'>Yemeni Ibrik — 15th Century, Birthplace of Coffee Culture</text><ellipse cx='380' cy='330' rx='140' ry='15' fill='#201008' opacity='0.5'/><ellipse cx='380' cy='326' rx='100' ry='10' fill='#2a1508' opacity='0.6'/><path d='M380 318 C275 315 260 240 295 195 C308 175 322 155 338 142 L422 142 C438 155 452 175 465 195 C500 240 485 315 380 318 Z' fill='url(#copper)' stroke='#c9a84c' stroke-width='1.5'/><path d='M370 308 C300 303 290 250 308 210 C315 190 330 168 342 150 L360 150 C345 170 330 195 325 215 C315 250 328 290 370 308 Z' fill='url(#gold)' opacity='0.25'/><path d='M338 160 C280 165 225 180 195 200 C178 212 165 225 170 242 C172 250 180 252 186 247 C192 242 198 230 210 218 C240 198 280 183 333 178 Z' fill='url(#copper)' stroke='#c9a84c' stroke-width='1.5'/><ellipse cx='180' cy='244' rx='7' ry='4' fill='#201008' stroke='#c9a84c' stroke-width='0.8'/><path d='M325 172 C275 178 230 195 200 215' fill='none' stroke='#e8c070' stroke-width='1.5' opacity='0.6'/><path d='M335 165 C290 168 245 182 215 200' fill='none' stroke='#f0d080' stroke-width='0.8' opacity='0.3'/><path d='M425 160 C495 155 540 180 528 222 C525 235 512 248 500 242 C494 238 494 234 500 230 C510 222 518 212 515 198 C508 182 488 173 438 175 Z' fill='url(#copper)' stroke='#c9a84c' stroke-width='1.5'/><path d='M440 170 C485 168 520 186 515 212 C512 223 505 228 498 225 C495 222 498 218 504 214 C510 208 506 192 488 182 C472 175 452 173 441 177 Z' fill='#1a1a2e'/><path d='M438 168 C492 163 530 186 524 220' fill='none' stroke='#e8c070' stroke-width='1.2' opacity='0.5'/><path d='M527 225 C536 232 532 242 524 238 C519 236 520 230 525 228' fill='none' stroke='#d4a85a' stroke-width='2' stroke-linecap='round'/><path d='M336 142 L424 142' stroke='#e8c070' stroke-width='3'/><path d='M310 195 Q380 208 450 195' fill='none' stroke='#c9a84c' stroke-width='1.5' opacity='0.8'/><path d='M312 200 Q380 213 448 200' fill='none' stroke='#c9a84c' stroke-width='0.8' opacity='0.5'/><path d='M294 250 Q380 264 466 250' fill='none' stroke='#c9a84c' stroke-width='1.5' opacity='0.8'/><path d='M296 255 Q380 269 464 255' fill='none' stroke='#c9a84c' stroke-width='0.8' opacity='0.5'/><path d='M300 290 Q380 302 460 290' fill='none' stroke='#c9a84c' stroke-width='1.2' opacity='0.6'/><path d='M348 170 L358 185 L348 200 L338 185 Z' fill='none' stroke='#e8c070' stroke-width='1' opacity='0.7'/><path d='M368 175 L378 190 L368 205 L358 190 Z' fill='none' stroke='#e8c070' stroke-width='1' opacity='0.7'/><path d='M388 170 L398 185 L388 200 L378 185 Z' fill='none' stroke='#e8c070' stroke-width='1' opacity='0.7'/><path d='M408 175 L418 190 L408 205 L398 190 Z' fill='none' stroke='#e8c070' stroke-width='1' opacity='0.7'/><path d='M328 215 L338 230 L328 245 L318 230 Z' fill='none' stroke='#e8c070' stroke-width='1' opacity='0.6'/><path d='M352 220 L362 235 L352 250 L342 235 Z' fill='none' stroke='#e8c070' stroke-width='1' opacity='0.6'/><path d='M378 222 L388 237 L378 252 L368 237 Z' fill='none' stroke='#e8c070' stroke-width='1' opacity='0.6'/><path d='M404 220 L414 235 L404 250 L394 235 Z' fill='none' stroke='#e8c070' stroke-width='1' opacity='0.6'/><path d='M428 215 L438 230 L428 245 L418 230 Z' fill='none' stroke='#e8c070' stroke-width='1' opacity='0.6'/><path d='M343 262 L353 277 L333 277 Z' fill='none' stroke='#d4a85a' stroke-width='0.8' opacity='0.5'/><path d='M363 267 L373 282 L353 282 Z' fill='none' stroke='#d4a85a' stroke-width='0.8' opacity='0.5'/><path d='M383 267 L393 282 L373 282 Z' fill='none' stroke='#d4a85a' stroke-width='0.8' opacity='0.5'/><path d='M403 262 L413 277 L393 277 Z' fill='none' stroke='#d4a85a' stroke-width='0.8' opacity='0.5'/><path d='M335 140 C335 102 380 88 425 140 Z' fill='url(#lid)' stroke='#c9a84c' stroke-width='1.5'/><path d='M350 135 C355 112 370 100 380 98' fill='none' stroke='#f0d080' stroke-width='1' opacity='0.5'/><ellipse cx='380' cy='96' rx='10' ry='4' fill='#c9a84c'/><ellipse cx='380' cy='88' rx='6' ry='8' fill='url(#copper)' stroke='#e8c070' stroke-width='1'/><circle cx='380' cy='80' r='4' fill='#e8c070'/><path d='M180 235 Q165 200 180 168 Q195 136 180 104 Q165 72 180 40' fill='none' stroke='url(#steam)' stroke-width='3' stroke-linecap='round' opacity='0.4'/><path d='M170 240 Q150 210 165 178 Q180 146 165 114 Q150 82 165 50' fill='none' stroke='url(#steam)' stroke-width='2.5' stroke-linecap='round' opacity='0.3'/><path d='M190 230 Q178 195 190 163 Q202 131 190 99 Q178 67 190 35' fill='none' stroke='url(#steam)' stroke-width='2' stroke-linecap='round' opacity='0.25'/><path d='M160 242 Q140 215 155 185 Q170 155 155 125' fill='none' stroke='url(#steam)' stroke-width='1.5' stroke-linecap='round' opacity='0.2'/><path d='M558 260 L575 302 L615 302 L632 260 Z' fill='url(#copper)' stroke='#c9a84c' stroke-width='1.2'/><ellipse cx='595' cy='302' rx='20' ry='4' fill='#8b6914' stroke='#c9a84c' stroke-width='0.8'/><ellipse cx='595' cy='260' rx='37' ry='6' fill='none' stroke='#e8c070' stroke-width='1.5'/><ellipse cx='595' cy='260' rx='32' ry='4' fill='#201008' opacity='0.8'/><path d='M561 272 Q595 280 629 272' fill='none' stroke='#e8c070' stroke-width='1' opacity='0.7'/><path d='M565 287 Q595 294 625 287' fill='none' stroke='#e8c070' stroke-width='0.8' opacity='0.5'/><path d='M632 265 C654 265 660 288 642 292' fill='none' stroke='#c9a84c' stroke-width='2.5' stroke-linecap='round'/><path d='M632 265 C650 267 654 286 642 290' fill='none' stroke='#e8c070' stroke-width='1' opacity='0.5' stroke-linecap='round'/><ellipse cx='595' cy='304' rx='28' ry='5' fill='none' stroke='#c9a84c' stroke-width='0.8' opacity='0.5'/><ellipse cx='280' cy='332' rx='10' ry='6' transform='rotate(-20 280 332)' fill='#5c3310' stroke='#8b6914' stroke-width='0.8'/><path d='M275 329 Q280 335 285 331' fill='none' stroke='#c9a84c' stroke-width='0.6' opacity='0.7'/><ellipse cx='460' cy='337' rx='9' ry='5.5' transform='rotate(15 460 337)' fill='#5c3310' stroke='#8b6914' stroke-width='0.8'/><path d='M456 334 Q460 340 464 336' fill='none' stroke='#c9a84c' stroke-width='0.6' opacity='0.7'/><ellipse cx='490' cy='327' rx='8' ry='5' transform='rotate(-35 490 327)' fill='#5c3310' stroke='#8b6914' stroke-width='0.8'/><path d='M486 324 Q490 330 494 326' fill='none' stroke='#c9a84c' stroke-width='0.6' opacity='0.7'/><ellipse cx='305' cy='340' rx='7' ry='4.5' transform='rotate(45 305 340)' fill='#5c3310' stroke='#8b6914' stroke-width='0.8'/><path d='M302 338 Q305 343 308 339' fill='none' stroke='#c9a84c' stroke-width='0.6' opacity='0.7'/><circle cx='308' cy='225' r='2' fill='#e8c070' opacity='0.5'/><circle cx='452' cy='225' r='2' fill='#e8c070' opacity='0.5'/><circle cx='303' cy='272' r='1.5' fill='#e8c070' opacity='0.4'/><circle cx='457' cy='272' r='1.5' fill='#e8c070' opacity='0.4'/><circle cx='380' cy='312' r='2' fill='#e8c070' opacity='0.3'/></svg>`;

// B2 — London coffeehouse (Samuel Pepys era)
SVG.B2=`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 400"><defs><linearGradient id="s3" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stop-color="#1a1a2e"/><stop offset="100%" stop-color="#0d0d1a"/></linearGradient></defs><rect width="800" height="400" fill="url(#s3)"/><g stroke="#c9a84c" fill="none" opacity=".06"><circle cx="60" cy="50" r="15"/><circle cx="60" cy="50" r="25"/><circle cx="740" cy="40" r="20"/><circle cx="740" cy="40" r="30"/></g><rect x="100" y="100" width="600" height="280" rx="4" fill="none" stroke="#c9a84c" stroke-width="1" opacity=".15"/><line x1="100" y1="160" x2="700" y2="160" stroke="#c9a84c" stroke-width=".5" opacity=".1"/><line x1="100" y1="310" x2="700" y2="310" stroke="#c9a84c" stroke-width=".5" opacity=".1"/><g stroke="#f5f0e6" fill="none" opacity=".4" stroke-linecap="round"><line x1="150" y1="270" x2="150" y2="330" stroke-width="3"/><circle cx="150" cy="260" r="10" stroke-width="2"/><line x1="130" y1="360" x2="170" y2="360" stroke-width="1.5"/><line x1="220" y1="270" x2="220" y2="330" stroke-width="3"/><circle cx="220" cy="260" r="10" stroke-width="2"/><line x1="200" y1="360" x2="240" y2="360" stroke-width="1.5"/></g><rect x="280" y="220" width="80" height="50" rx="3" fill="none" stroke="#f5f0e6" stroke-width="1" opacity=".25"/><rect x="380" y="220" width="80" height="50" rx="3" fill="none" stroke="#f5f0e6" stroke-width="1" opacity=".25"/><rect x="480" y="220" width="80" height="50" rx="3" fill="none" stroke="#f5f0e6" stroke-width="1" opacity=".25"/><circle cx="320" cy="245" r="6" fill="none" stroke="#c9a84c" stroke-width="1" opacity=".35"/><circle cx="420" cy="245" r="6" fill="none" stroke="#c9a84c" stroke-width="1" opacity=".35"/><circle cx="520" cy="245" r="6" fill="none" stroke="#c9a84c" stroke-width="1" opacity=".35"/><g stroke="#c9a84c" fill="none" opacity=".15"><line x1="250" y1="180" x2="280" y2="222" stroke-width="1"/><line x1="350" y1="180" x2="280" y2="222" stroke-width="1"/><line x1="350" y1="180" x2="380" y2="222" stroke-width="1"/><line x1="450" y1="180" x2="380" y2="222" stroke-width="1"/><line x1="450" y1="180" x2="480" y2="222" stroke-width="1"/><line x1="550" y1="180" x2="480" y2="222" stroke-width="1"/><line x1="550" y1="180" x2="560" y2="222" stroke-width="1"/></g><text x="400" y="175" text-anchor="middle" fill="#c9a84c" font-size="13" opacity=".4" font-family="serif" font-style="italic">Penny Universities — London, 1660s</text><g stroke="#c9a84c" fill="none" opacity=".08" stroke-dasharray="2 3"><line x1="120" y1="330" x2="165" y2="330"/><line x1="190" y1="330" x2="250" y2="330"/></g><text x="400" y="45" text-anchor="middle" fill="#c9a84c" font-size="26" font-family="serif" font-weight="bold">سر القهوة الخفي</text><text x="400" y="68" text-anchor="middle" fill="#f5f0e6" font-size="14" opacity=".6" font-family="sans-serif">Water &amp; Coffee — Samuel Pepys' Discovery, 1663</text></svg>`;

// C3 — Ottoman coffeehouse
SVG.C3=`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 400"><defs><linearGradient id="s4" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stop-color="#2d1b00"/><stop offset="100%" stop-color="#1a1a2e"/></linearGradient></defs><rect width="800" height="400" fill="url(#s4)"/><g stroke="#c9a84c" fill="none" opacity=".06"><circle cx="700" cy="50" r="20"/><circle cx="700" cy="50" r="30"/><circle cx="100" cy="60" r="15"/><circle cx="100" cy="60" r="25"/></g><path d="M100 100Q200 60 400 60Q600 60 700 100L720 380H80Z" fill="none" stroke="#c9a84c" stroke-width="1" opacity=".15"/><path d="M150 100Q250 70 400 70Q550 70 650 100" fill="none" stroke="#c9a84c" stroke-width="1.5" opacity=".2"/><g stroke="#f5f0e6" fill="none" opacity=".35" stroke-linecap="round"><line x1="200" y1="280" x2="200" y2="350" stroke-width="3"/><circle cx="200" cy="268" r="11" stroke-width="2"/><line x1="200" y1="300" x2="180" y2="320" stroke-width="2"/><line x1="200" y1="300" x2="220" y2="320" stroke-width="2"/><line x1="320" y1="280" x2="320" y2="350" stroke-width="3"/><circle cx="320" cy="268" r="11" stroke-width="2"/><line x1="320" y1="300" x2="300" y2="320" stroke-width="2"/><line x1="320" y1="300" x2="340" y2="320" stroke-width="2"/><line x1="480" y1="280" x2="480" y2="350" stroke-width="3"/><circle cx="480" cy="268" r="11" stroke-width="2"/><line x1="480" y1="300" x2="460" y2="320" stroke-width="2"/><line x1="480" y1="300" x2="500" y2="320" stroke-width="2"/><line x1="590" y1="280" x2="590" y2="350" stroke-width="3"/><circle cx="590" cy="268" r="11" stroke-width="2"/><line x1="590" y1="300" x2="570" y2="320" stroke-width="2"/><line x1="590" y1="300" x2="610" y2="320" stroke-width="2"/></g><rect x="235" y="335" width="50" height="35" rx="2" fill="none" stroke="#c9a84c" stroke-width=".8" opacity=".25"/><rect x="425" y="335" width="50" height="35" rx="2" fill="none" stroke="#c9a84c" stroke-width=".8" opacity=".25"/><circle cx="260" cy="350" r="4" fill="none" stroke="#c9a84c" stroke-width=".8" opacity=".3"/><circle cx="450" cy="350" r="4" fill="none" stroke="#c9a84c" stroke-width=".8" opacity=".3"/><g fill="none" stroke="#c9a84c" opacity=".08"><circle cx="400" cy="200" r="60"/><circle cx="400" cy="200" r="80"/></g><text x="400" y="205" text-anchor="middle" fill="#c9a84c" font-size="36" opacity=".3">🏪</text><line x1="100" y1="380" x2="700" y2="380" stroke="#c9a84c" stroke-width=".5" opacity=".2"/><text x="400" y="45" text-anchor="middle" fill="#c9a84c" font-size="26" font-family="serif" font-weight="bold">مدارس الحكمة</text><text x="400" y="68" text-anchor="middle" fill="#f5f0e6" font-size="14" opacity=".6" font-family="sans-serif">Ottoman Coffeehouses — Istanbul, 1555 — The Original Third Place</text></svg>`;

// A3 — Espresso machine with portafilter and crema shot
SVG.A3=`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 400"><defs><linearGradient id="s5" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stop-color="#1a1a2e"/><stop offset="100%" stop-color="#0d0d1a"/></linearGradient><linearGradient id="cr" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stop-color="#d4a04a"/><stop offset="40%" stop-color="#8b4513"/><stop offset="100%" stop-color="#3d1c00"/></linearGradient><radialGradient id="crema"><stop offset="0%" stop-color="#e8c070"/><stop offset="60%" stop-color="#c8923a"/><stop offset="100%" stop-color="#a07030"/></radialGradient><linearGradient id="mc" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stop-color="#6ac"/><stop offset="100%" stop-color="#458"/></linearGradient></defs><rect width="800" height="400" fill="url(#s5)"/><g stroke="#c9a84c" fill="none" opacity=".06"><circle cx="700" cy="40" r="20"/><circle cx="700" cy="40" r="35"/><circle cx="80" cy="50" r="15"/><circle cx="80" cy="50" r="25"/></g><rect x="250" y="60" width="180" height="250" rx="12" fill="#2a2a3a" stroke="#555" stroke-width="1.5"/><rect x="260" y="70" width="160" height="60" rx="4" fill="#1a1a28"/><rect x="275" y="80" width="130" height="40" rx="20" fill="#c9a84c" opacity=".15"/><circle cx="340" cy="100" r="14" fill="none" stroke="#c9a84c" stroke-width="2" opacity=".6"/><circle cx="340" cy="100" r="6" fill="#c9a84c" opacity=".4"/><circle cx="340" cy="145" r="18" fill="#1a1a28" stroke="#666" stroke-width="1"/><line x1="340" y1="145" x2="352" y2="135" stroke="#c9a84c" stroke-width="2" stroke-linecap="round"/><circle cx="340" cy="145" r="2" fill="#c9a84c"/><rect x="280" y="175" width="18" height="18" rx="3" fill="#3a3a4a"/><rect x="310" y="175" width="18" height="18" rx="3" fill="#3a3a4a"/><rect x="340" y="175" width="18" height="18" rx="3" fill="#3a3a4a"/><rect x="370" y="175" width="18" height="18" rx="3" fill="#c0392b"/><rect x="300" y="200" width="80" height="12" rx="3" fill="#444"/><rect x="320" y="212" width="40" height="8" rx="2" fill="#555"/><path d="M260 220L420 220Q430 220 430 230L420 240H260L250 230Q250 220 260 220Z" fill="#333" stroke="#555" stroke-width="1"/><ellipse cx="340" cy="230" rx="36" ry="8" fill="none" stroke="#666" stroke-width="1" opacity=".5"/><rect x="255" y="280" width="170" height="20" rx="4" fill="#333" stroke="#555" stroke-width="1"/><rect x="260" y="300" width="160" height="8" rx="2" fill="#2a2a3a"/><line x1="430" y1="130" x2="500" y2="200" stroke="#aaa" stroke-width="4" stroke-linecap="round"/><ellipse cx="500" cy="205" rx="6" ry="10" fill="none" stroke="#aaa" stroke-width="2"/><rect x="300" y="190" width="80" height="14" rx="6" fill="#555" stroke="#666" stroke-width="1"/><rect x="315" y="240" width="50" height="35" rx="3" fill="none" stroke="#666" stroke-width="1"/><path d="M320 240L350 255L380 240" fill="none" stroke="#c9a84c" stroke-width="1.5" opacity=".5"/><ellipse cx="350" cy="255" rx="16" ry="18" fill="url(#cr)" opacity=".8"/><ellipse cx="350" cy="250" rx="12" ry="6" fill="url(#crema)" opacity=".9"/><text x="400" y="80" fill="#c9a84c" font-size="9" opacity=".4" font-family="sans-serif">ESPRESSO</text><text x="400" y="390" text-anchor="middle" fill="#c9a84c" font-size="11" opacity=".4" font-family="serif">الإسبريسو — The Heart of Italian Coffee</text></svg>`;

// B1 — Roasting drum with roast curve chart
SVG.B1=`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 400"><defs><linearGradient id="s6" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stop-color="#2a1a00"/><stop offset="100%" stop-color="#1a0d00"/></linearGradient><radialGradient id="fr"><stop offset="0%" stop-color="#fff5e6"/><stop offset="40%" stop-color="#f5d6a8"/><stop offset="70%" stop-color="#c9883a"/><stop offset="100%" stop-color="#5a3010"/></radialGradient></defs><rect width="800" height="400" fill="url(#s6)"/><g stroke="#c9a84c" fill="none" opacity=".06"><circle cx="680" cy="50" r="20"/><circle cx="680" cy="50" r="35"/><circle cx="100" cy="60" r="15"/><circle cx="100" cy="60" r="25"/></g><ellipse cx="200" cy="220" rx="90" ry="75" fill="#3d2a1a" stroke="#5a3a1a" stroke-width="3"/><ellipse cx="200" cy="220" rx="86" ry="71" fill="none" stroke="#c9a84c" stroke-width=".5" opacity=".15"/><ellipse cx="200" cy="220" rx="80" ry="65" fill="none" stroke="#c9a84c" stroke-width=".5" opacity=".1"/><line x1="120" y1="220" x2="280" y2="220" stroke="#c9a84c" stroke-width=".5" opacity=".12"/><line x1="200" y1="149" x2="200" y2="291" stroke="#c9a84c" stroke-width=".5" opacity=".12"/><circle cx="200" cy="220" r="30" fill="none" stroke="#c9a84c" stroke-width=".8" opacity=".2"/><circle cx="200" cy="220" r="15" fill="none" stroke="#c9a84c" stroke-width=".6" opacity=".15"/><circle cx="200" cy="220" r="4" fill="#c9a84c" opacity=".3"/><circle cx="170" cy="200" r="5" fill="#8b6914" opacity=".7"/><circle cx="220" cy="240" r="5" fill="#8b6914" opacity=".7"/><circle cx="180" cy="250" r="5" fill="#8b6914" opacity=".7"/><circle cx="230" cy="195" r="5" fill="#8b6914" opacity=".7"/><circle cx="160" cy="230" r="5" fill="#8b6914" opacity=".7"/><circle cx="210" cy="185" r="4" fill="#a87d2a" opacity=".7"/><circle cx="175" cy="235" r="4" fill="#a87d2a" opacity=".7"/><circle cx="240" cy="210" r="4" fill="#a87d2a" opacity=".7"/><circle cx="185" cy="205" r="3" fill="#c9a84c" opacity=".5"/><circle cx="215" cy="245" r="3" fill="#c9a84c" opacity=".5"/><line x1="100" y1="220" x2="120" y2="220" stroke="#666" stroke-width="4"/><line x1="280" y1="220" x2="350" y2="220" stroke="#666" stroke-width="4"/><circle cx="350" cy="220" r="10" fill="#444" stroke="#666" stroke-width="1.5"/><rect x="340" y="230" width="20" height="10" rx="2" fill="#333"/><rect x="420" y="100" width="340" height="220" rx="6" fill="#1a1a28" stroke="#444" stroke-width="1"/><line x1="450" y1="300" x2="730" y2="300" stroke="#555" stroke-width="1"/><line x1="450" y1="120" x2="450" y2="300" stroke="#555" stroke-width="1"/><path d="M450 290Q470 285 490 280Q520 270 540 260Q560 240 580 230Q600 215 620 200Q640 185 660 170Q680 155 700 140L730 140" fill="none" stroke="#e8c070" stroke-width="2.5" stroke-linecap="round"/><text x="460" y="320" fill="#666" font-size="8" font-family="mono">0</text><text x="715" y="320" fill="#666" font-size="8" font-family="mono">T</text><text x="440" y="125" fill="#666" font-size="8" font-family="mono">C</text><circle cx="580" cy="230" r="4" fill="#e74c3c"/><text x="560" y="220" fill="#e74c3c" font-size="8" font-family="mono">FC</text><circle cx="620" cy="200" r="4" fill="#e67e22"/><text x="605" y="190" fill="#e67e22" font-size="8" font-family="mono">SC</text><text x="590" y="360" text-anchor="middle" fill="#c9a84c" font-size="11" opacity=".5" font-family="serif">منحنى التحميص — Roast Profile Curve</text></svg>`;

// B3 — Grind size comparison chart
SVG.B3=`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 400"><defs><linearGradient id="s7" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stop-color="#1a1a2e"/><stop offset="100%" stop-color="#0d0d1a"/></linearGradient></defs><rect width="800" height="400" fill="url(#s7)"/><g stroke="#c9a84c" fill="none" opacity=".06"><circle cx="720" cy="40" r="20"/><circle cx="720" cy="40" r="35"/><circle cx="60" cy="50" r="15"/></g><text x="400" y="40" text-anchor="middle" fill="#c9a84c" font-size="13" opacity=".6" font-family="sans-serif">COMPARISON — GRIND SIZE &amp; BREWING METHOD</text><rect x="30" y="70" width="150" height="60" rx="8" fill="#2a1a0a" stroke="#c9a84c" stroke-width="1" opacity=".7"/><text x="105" y="95" text-anchor="middle" fill="#c9a84c" font-size="10" font-family="sans-serif" font-weight="bold">Turkish / Ibrik</text><text x="105" y="115" text-anchor="middle" fill="#aaa" font-size="8" font-family="sans-serif">ناعم جداً • Extra Fine</text><g fill="#c9a84c" opacity=".9"><circle cx="55" cy="140" r="2"/><circle cx="65" cy="140" r="2"/><circle cx="75" cy="140" r="2"/><circle cx="85" cy="140" r="2"/><circle cx="95" cy="140" r="2"/><circle cx="105" cy="140" r="2"/><circle cx="115" cy="140" r="2"/><circle cx="125" cy="140" r="2"/><circle cx="135" cy="140" r="2"/><circle cx="145" cy="140" r="2"/><circle cx="155" cy="140" r="2"/><circle cx="165" cy="140" r="2"/></g><rect x="220" y="70" width="150" height="60" rx="8" fill="#2a1a0a" stroke="#c9a84c" stroke-width="1" opacity=".7"/><text x="295" y="95" text-anchor="middle" fill="#c9a84c" font-size="10" font-family="sans-serif" font-weight="bold">Espresso</text><text x="295" y="115" text-anchor="middle" fill="#aaa" font-size="8" font-family="sans-serif">ناعم • Fine</text><g fill="#c9a84c" opacity=".8"><circle cx="250" cy="140" r="3"/><circle cx="263" cy="140" r="3"/><circle cx="276" cy="140" r="3"/><circle cx="289" cy="140" r="3"/><circle cx="302" cy="140" r="3"/><circle cx="315" cy="140" r="3"/><circle cx="328" cy="140" r="3"/><circle cx="341" cy="140" r="3"/></g><rect x="410" y="70" width="150" height="60" rx="8" fill="#2a1a0a" stroke="#c9a84c" stroke-width="1" opacity=".7"/><text x="485" y="95" text-anchor="middle" fill="#c9a84c" font-size="10" font-family="sans-serif" font-weight="bold">Pour Over (V60)</text><text x="485" y="115" text-anchor="middle" fill="#aaa" font-size="8" font-family="sans-serif">متوسط • Medium</text><g fill="#c9a84c" opacity=".7"><circle cx="440" cy="140" r="4"/><circle cx="456" cy="140" r="4"/><circle cx="472" cy="140" r="4"/><circle cx="488" cy="140" r="4"/><circle cx="504" cy="140" r="4"/><circle cx="520" cy="140" r="4"/><circle cx="536" cy="140" r="4"/></g><rect x="600" y="70" width="170" height="60" rx="8" fill="#2a1a0a" stroke="#c9a84c" stroke-width="1" opacity=".7"/><text x="685" y="95" text-anchor="middle" fill="#c9a84c" font-size="10" font-family="sans-serif" font-weight="bold">French Press</text><text x="685" y="115" text-anchor="middle" fill="#aaa" font-size="8" font-family="sans-serif">خشن • Coarse</text><g fill="#c9a84c" opacity=".6"><circle cx="630" cy="140" r="5"/><circle cx="648" cy="140" r="5"/><circle cx="666" cy="140" r="5"/><circle cx="684" cy="140" r="5"/><circle cx="702" cy="140" r="5"/><circle cx="720" cy="140" r="5"/></g><text x="400" y="185" text-anchor="middle" fill="#aaa" font-size="10" font-family="sans-serif" opacity=".7">— Extraction Rate vs. Grind Size —</text><rect x="100" y="200" width="600" height="120" rx="6" fill="#1a1a28" stroke="#444" stroke-width="1"/><text x="120" y="220" fill="#e74c3c" font-size="8" font-family="mono">Under-extracted</text><text x="500" y="220" fill="#e67e22" font-size="8" font-family="mono">Over-extracted</text><path d="M120 280Q200 280 280 260Q360 220 440 200Q520 180 600 190L680 210" fill="none" stroke="#e8c070" stroke-width="2" stroke-linecap="round"/><rect x="360" y="230" width="80" height="24" rx="4" fill="#27ae60" opacity=".6"/><text x="400" y="247" text-anchor="middle" fill="#fff" font-size="9" font-family="sans-serif">SWEET SPOT</text><text x="400" y="345" text-anchor="middle" fill="#c9a84c" font-size="11" opacity=".5" font-family="serif">حجم الطحن — Grind Size &amp; Extraction</text></svg>`;

// C1 — Cupping setup with flavor wheel
SVG.C1=`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 400"><defs><linearGradient id="s8" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stop-color="#1a1a2e"/><stop offset="100%" stop-color="#0d0d1a"/></linearGradient><radialGradient id="fw"><stop offset="0%" stop-color="#fff"/><stop offset="15%" stop-color="#f5e6c8"/><stop offset="35%" stop-color="#e8c070"/><stop offset="55%" stop-color="#c97030"/><stop offset="75%" stop-color="#8b3a1a"/><stop offset="100%" stop-color="#3d1c00"/></radialGradient></defs><rect width="800" height="400" fill="url(#s8)"/><g stroke="#c9a84c" fill="none" opacity=".06"><circle cx="700" cy="45" r="20"/><circle cx="700" cy="45" r="35"/></g><text x="400" y="35" text-anchor="middle" fill="#c9a84c" font-size="13" opacity=".6" font-family="sans-serif">CUPPING LAB — Sensory &amp; Quality Control</text><circle cx="200" cy="220" r="120" fill="url(#fw)" opacity=".7"/><circle cx="200" cy="220" r="120" fill="none" stroke="#c9a84c" stroke-width="1.5" opacity=".4"/><circle cx="200" cy="220" r="90" fill="none" stroke="#c9a84c" stroke-width=".8" opacity=".25"/><circle cx="200" cy="220" r="60" fill="none" stroke="#c9a84c" stroke-width=".8" opacity=".25"/><circle cx="200" cy="220" r="30" fill="none" stroke="#c9a84c" stroke-width=".8" opacity=".25"/><line x1="200" y1="100" x2="200" y2="340" stroke="#c9a84c" stroke-width=".5" opacity=".2"/><line x1="80" y1="220" x2="320" y2="220" stroke="#c9a84c" stroke-width=".5" opacity=".2"/><line x1="115" y1="135" x2="285" y2="305" stroke="#c9a84c" stroke-width=".5" opacity=".2"/><line x1="115" y1="305" x2="285" y2="135" stroke="#c9a84c" stroke-width=".5" opacity=".2"/><text x="200" y="100" text-anchor="middle" fill="#e8c070" font-size="7" font-family="sans-serif" opacity=".5" transform="translate(0,-8)">Flower</text><text x="200" y="340" text-anchor="middle" fill="#8b3a1a" font-size="7" font-family="sans-serif" opacity=".5" transform="translate(0,14)">Woody</text><text x="75" y="224" text-anchor="middle" fill="#c97030" font-size="7" font-family="sans-serif" opacity=".5" transform="translate(-5,0)">Spice</text><text x="325" y="224" text-anchor="middle" fill="#f5e6c8" font-size="7" font-family="sans-serif" opacity=".5" transform="translate(5,0)">Sweet</text><text x="128" y="135" text-anchor="middle" fill="#e8c070" font-size="7" font-family="sans-serif" opacity=".5" transform="translate(-5,-5)">Fruit</text><text x="272" y="305" text-anchor="middle" fill="#8b3a1a" font-size="7" font-family="sans-serif" opacity=".5" transform="translate(5,5)">Nut</text><text x="128" y="305" text-anchor="middle" fill="#c97030" font-size="7" font-family="sans-serif" opacity=".5" transform="translate(-5,5)">Earthy</text><text x="272" y="135" text-anchor="middle" fill="#f5e6c8" font-size="7" font-family="sans-serif" opacity=".5" transform="translate(5,-5)">Citrus</text><rect x="350" y="180" width="20" height="80" rx="10" fill="#aaa" opacity=".6"/><ellipse cx="360" cy="175" rx="14" ry="8" fill="#c9a84c" opacity=".5"/><rect x="385" y="185" width="20" height="80" rx="10" fill="#aaa" opacity=".5"/><ellipse cx="395" cy="180" rx="14" ry="8" fill="#c9a84c" opacity=".4"/><rect x="420" y="175" width="20" height="80" rx="10" fill="#aaa" opacity=".5"/><ellipse cx="430" cy="170" rx="14" ry="8" fill="#c9a84c" opacity=".4"/><ellipse cx="380" cy="300" rx="32" ry="14" fill="#2a1a0a" stroke="#c9a84c" stroke-width=".8" opacity=".7"/><ellipse cx="380" cy="295" rx="24" ry="8" fill="#3d2a1a" opacity=".6"/><ellipse cx="480" cy="295" rx="32" ry="14" fill="#2a1a0a" stroke="#c9a84c" stroke-width=".8" opacity=".7"/><ellipse cx="480" cy="290" rx="24" ry="8" fill="#3d2a1a" opacity=".6"/><ellipse cx="580" cy="300" rx="32" ry="14" fill="#2a1a0a" stroke="#c9a84c" stroke-width=".8" opacity=".7"/><ellipse cx="580" cy="295" rx="24" ry="8" fill="#3d2a1a" opacity=".6"/><text x="380" y="362" text-anchor="middle" fill="#aaa" font-size="8" font-family="sans-serif">Smell the aroma</text><text x="480" y="360" text-anchor="middle" fill="#aaa" font-size="8" font-family="sans-serif">Break the crust</text><text x="580" y="362" text-anchor="middle" fill="#aaa" font-size="8" font-family="sans-serif">Slurp &amp; evaluate</text><text x="400" y="392" text-anchor="middle" fill="#c9a84c" font-size="11" opacity=".5" font-family="serif">الكَبّ — Cupping &amp; Flavor Evaluation</text></svg>`;

// C2 — Coffee processing methods comparison
SVG.C2=`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 400"><defs><linearGradient id="s9" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stop-color="#1a2e1a"/><stop offset="100%" stop-color="#0d1a0d"/></linearGradient></defs><rect width="800" height="400" fill="url(#s9)"/><g stroke="#c9a84c" fill="none" opacity=".06"><circle cx="700" cy="40" r="20"/><circle cx="700" cy="40" r="35"/><circle cx="80" cy="50" r="15"/></g><text x="400" y="40" text-anchor="middle" fill="#c9a84c" font-size="13" opacity=".6" font-family="sans-serif">PROCESSING METHODS — From Cherry to Green Bean</text><rect x="25" y="65" width="230" height="190" rx="8" fill="#1a1a28" stroke="#c9a84c" stroke-width=".8" opacity=".5"/><text x="140" y="88" text-anchor="middle" fill="#e8c070" font-size="11" font-family="sans-serif" font-weight="bold">Washed / Wet</text><text x="140" y="103" text-anchor="middle" fill="#aaa" font-size="8" font-family="sans-serif">مغسول</text><circle cx="80" cy="135" r="12" fill="none" stroke="#cc3333" stroke-width="1.5"/><circle cx="80" cy="135" r="6" fill="#cc3333" opacity=".5"/><text x="80" y="160" text-anchor="middle" fill="#888" font-size="7" font-family="sans-serif">Cherry</text><path d="M95 135L120 135" stroke="#666" stroke-width="1.5"/><circle cx="135" cy="135" r="10" fill="none" stroke="#c9a84c" stroke-width="1.5"/><text x="135" y="160" text-anchor="middle" fill="#888" font-size="7" font-family="sans-serif">Depulped</text><path d="M150 135L175 135" stroke="#666" stroke-width="1.5"/><circle cx="190" cy="135" r="10" fill="none" stroke="#3a7a33" stroke-width="1.5"/><text x="190" y="160" text-anchor="middle" fill="#888" font-size="7" font-family="sans-serif">Ferment</text><rect x="80" y="185" width="130" height="40" rx="4" fill="#2a2a3a" stroke="#555" stroke-width=".5"/><text x="145" y="200" text-anchor="middle" fill="#c9a84c" font-size="7" font-family="sans-serif">Clean, bright</text><text x="145" y="215" text-anchor="middle" fill="#c9a84c" font-size="7" font-family="sans-serif">High acidity</text><rect x="285" y="65" width="230" height="190" rx="8" fill="#1a1a28" stroke="#c9a84c" stroke-width=".8" opacity=".5"/><text x="400" y="88" text-anchor="middle" fill="#e8c070" font-size="11" font-family="sans-serif" font-weight="bold">Natural / Dry</text><text x="400" y="103" text-anchor="middle" fill="#aaa" font-size="8" font-family="sans-serif">طبيعي</text><circle cx="340" cy="135" r="12" fill="#cc3333" opacity=".6"/><text x="340" y="160" text-anchor="middle" fill="#888" font-size="7" font-family="sans-serif">Cherry</text><path d="M355 135L380 135" stroke="#666" stroke-width="1.5"/><rect x="385" y="125" width="40" height="20" rx="3" fill="#c9a84c" opacity=".15"/><text x="405" y="138" text-anchor="middle" fill="#c9a84c" font-size="7" font-family="sans-serif">Sun dry</text><text x="405" y="160" text-anchor="middle" fill="#888" font-size="7" font-family="sans-serif">Sun dry</text><path d="M425 135L440 135" stroke="#666" stroke-width="1.5"/><circle cx="455" cy="135" r="10" fill="none" stroke="#8b6914" stroke-width="1.5"/><text x="455" y="160" text-anchor="middle" fill="#888" font-size="7" font-family="sans-serif">Hulled</text><rect x="340" y="185" width="130" height="40" rx="4" fill="#2a2a3a" stroke="#555" stroke-width=".5"/><text x="405" y="200" text-anchor="middle" fill="#c9a84c" font-size="7" font-family="sans-serif">Full body</text><text x="405" y="215" text-anchor="middle" fill="#c9a84c" font-size="7" font-family="sans-serif">Fruity, wild</text><rect x="545" y="65" width="230" height="190" rx="8" fill="#1a1a28" stroke="#c9a84c" stroke-width=".8" opacity=".5"/><text x="660" y="88" text-anchor="middle" fill="#e8c070" font-size="11" font-family="sans-serif" font-weight="bold">Honey</text><text x="660" y="103" text-anchor="middle" fill="#aaa" font-size="8" font-family="sans-serif">عسلي</text><circle cx="600" cy="135" r="12" fill="#cc3333" opacity=".5"/><text x="600" y="160" text-anchor="middle" fill="#888" font-size="7" font-family="sans-serif">Cherry</text><path d="M615 135L640 135" stroke="#666" stroke-width="1.5"/><circle cx="655" cy="135" r="10" fill="none" stroke="#c9a84c" stroke-width="1.5"/><text x="655" y="160" text-anchor="middle" fill="#888" font-size="7" font-family="sans-serif">Depulped</text><path d="M670 135L695 135" stroke="#666" stroke-width="1.5"/><circle cx="710" cy="135" r="10" fill="none" stroke="#c9a84c" stroke-width="2" opacity=".4"/><text x="710" y="160" text-anchor="middle" fill="#888" font-size="7" font-family="sans-serif">Mucilage</text><rect x="600" y="185" width="130" height="40" rx="4" fill="#2a2a3a" stroke="#555" stroke-width=".5"/><text x="665" y="200" text-anchor="middle" fill="#c9a84c" font-size="7" font-family="sans-serif">Sweet, syrupy</text><text x="665" y="215" text-anchor="middle" fill="#c9a84c" font-size="7" font-family="sans-serif">Balanced</text><text x="400" y="282" text-anchor="middle" fill="#aaa" font-size="9" font-family="sans-serif">— Traditional vs. Experimental —</text><text x="400" y="296" text-anchor="middle" fill="#888" font-size="8" font-family="sans-serif">Anaerobic • Carbonic Maceration • Wineye • Lactic</text><text x="400" y="315" text-anchor="middle" fill="#666" font-size="8" font-family="sans-serif">Traditional | Experimental → More complexity, higher risk</text><text x="400" y="345" text-anchor="middle" fill="#c9a84c" font-size="10" opacity=".5" font-family="serif">المعالجة — Coffee Processing Methods</text></svg>`;

// V60 — V60 pour-over brewing diagram
SVG.V60=`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 600 350"><defs><linearGradient id="gv60" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stop-color="#1a1a2e"/><stop offset="100%" stop-color="#0d0d1a"/></linearGradient></defs><rect width="600" height="350" fill="url(#gv60)"/><g stroke="#c9a84c" fill="none" opacity=".06"><circle cx="550" cy="40" r="15"/><circle cx="550" cy="40" r="25"/></g><text x="300" y="28" text-anchor="middle" fill="#c9a84c" font-size="11" opacity=".6" font-family="sans-serif">V60 POUR-OVER — Step by Step</text><path d="M220 100L240 200L360 200L380 100Z" fill="none" stroke="#c9a84c" stroke-width="2" opacity=".7"/><path d="M230 120L245 190L355 190L370 120Z" fill="none" stroke="#c9a84c" stroke-width="1.5" opacity=".4"/><line x1="235" y1="130" x2="365" y2="130" stroke="#c9a84c" stroke-width=".8" opacity=".3"/><line x1="250" y1="150" x2="350" y2="150" stroke="#c9a84c" stroke-width=".8" opacity=".3"/><line x1="260" y1="170" x2="340" y2="170" stroke="#c9a84c" stroke-width=".8" opacity=".3"/><path d="M280 80L290 110" stroke="#6af" stroke-width="2" opacity=".4"/><path d="M300 75L300 110" stroke="#6af" stroke-width="2" opacity=".5"/><path d="M320 80L310 110" stroke="#6af" stroke-width="2" opacity=".4"/><path d="M100 70Q180 50 280 80" fill="none" stroke="#aaa" stroke-width="2.5"/><ellipse cx="100" cy="72" rx="14" ry="8" fill="#444" stroke="#888" stroke-width="1"/><path d="M250 210L280 300L320 300L350 210Z" fill="none" stroke="#c9a84c" stroke-width="1.5" opacity=".5"/><ellipse cx="300" cy="210" rx="50" ry="8" fill="none" stroke="#c9a84c" stroke-width="1.5" opacity=".5"/><rect x="260" y="305" width="80" height="10" rx="3" fill="none" stroke="#555" stroke-width="1"/><text x="300" y="335" text-anchor="middle" fill="#aaa" font-size="8" font-family="sans-serif">1. Bloom (30s) 2. Main pour 3. Drawdown (2:30-3:00)</text><text x="300" y="350" text-anchor="middle" fill="#c9a84c" font-size="9" opacity=".4" font-family="serif">تحضير V60</text></svg>`;

// MAP — Coffee spread world map
SVG.map=`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 600 350"><defs><linearGradient id="gmap" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stop-color="#0d1a2e"/><stop offset="100%" stop-color="#1a1a2e"/></linearGradient></defs><rect width="600" height="350" fill="url(#gmap)"/><g stroke="#c9a84c" fill="none" opacity=".06"><circle cx="560" cy="35" r="15"/><circle cx="560" cy="35" r="25"/></g><text x="300" y="28" text-anchor="middle" fill="#c9a84c" font-size="11" opacity=".6" font-family="sans-serif">COFFEE's JOURNEY — Ethiopia to the World</text><ellipse cx="120" cy="200" rx="60" ry="80" fill="none" stroke="#3a7a33" stroke-width="2" opacity=".5"/><circle cx="110" cy="180" r="6" fill="#cc3333" opacity=".8"/><text x="110" y="195" text-anchor="middle" fill="#cc3333" font-size="7" font-family="sans-serif">Ethiopia</text><ellipse cx="190" cy="170" rx="20" ry="25" fill="none" stroke="#c9a84c" stroke-width="1.5" opacity=".4"/><text x="190" y="175" text-anchor="middle" fill="#c9a84c" font-size="6" font-family="sans-serif">Yemen</text><ellipse cx="220" cy="110" rx="30" ry="40" fill="none" stroke="#c9a84c" stroke-width="1.5" opacity=".3"/><text x="220" y="105" text-anchor="middle" fill="#c9a84c" font-size="6" font-family="sans-serif">Europe</text><ellipse cx="300" cy="130" rx="25" ry="20" fill="none" stroke="#c9a84c" stroke-width="1.5" opacity=".3"/><text x="300" y="128" text-anchor="middle" fill="#c9a84c" font-size="6" font-family="sans-serif">Istanbul</text><ellipse cx="430" cy="160" rx="30" ry="20" fill="none" stroke="#3a7a33" stroke-width="1.5" opacity=".4"/><text x="430" y="158" text-anchor="middle" fill="#3a7a33" font-size="6" font-family="sans-serif">Java</text><ellipse cx="470" cy="220" rx="40" ry="50" fill="none" stroke="#3a7a33" stroke-width="1.5" opacity=".4"/><text x="470" y="225" text-anchor="middle" fill="#3a7a33" font-size="6" font-family="sans-serif">Brazil</text><path d="M120 185L170 175" stroke="#e8c070" stroke-width="1.5" opacity=".6"/><path d="M200 168L210 150" stroke="#e8c070" stroke-width="1.5" opacity=".6"/><path d="M205 155L280 135" stroke="#e8c070" stroke-width="1.5" opacity=".5"/><path d="M320 135L410 158" stroke="#e8c070" stroke-width="1.5" opacity=".5"/><path d="M440 170L460 200" stroke="#e8c070" stroke-width="1.5" opacity=".5"/><text x="165" y="160" fill="#e8c070" font-size="5" font-family="sans-serif" opacity=".5">1 (1400s)</text><text x="340" y="120" fill="#e8c070" font-size="5" font-family="sans-serif" opacity=".5">2 (1500s)</text><text x="400" y="145" fill="#e8c070" font-size="5" font-family="sans-serif" opacity=".5">3 (1690s)</text><text x="470" y="190" fill="#e8c070" font-size="5" font-family="sans-serif" opacity=".5">4 (1727)</text><text x="300" y="335" text-anchor="middle" fill="#c9a84c" font-size="9" opacity=".4" font-family="serif">خريطة انتشار القهوة</text></svg>`;

// RC — Roasting cycle
SVG.roastCycle=`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 600 350"><defs><linearGradient id="grc" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stop-color="#2a1a00"/><stop offset="100%" stop-color="#1a0d00"/></linearGradient><radialGradient id="rheat"><stop offset="0%" stop-color="#e8c070"/><stop offset="50%" stop-color="#c97030"/><stop offset="100%" stop-color="#8b3a1a"/></radialGradient></defs><rect width="600" height="350" fill="url(#grc)"/><g stroke="#c9a84c" fill="none" opacity=".06"><circle cx="560" cy="35" r="15"/><circle cx="560" cy="35" r="25"/></g><text x="300" y="28" text-anchor="middle" fill="#c9a84c" font-size="11" opacity=".6" font-family="sans-serif">ROASTING CYCLE — Green to Brown</text><ellipse cx="180" cy="200" rx="70" ry="60" fill="none" stroke="#5a3a1a" stroke-width="3" opacity=".5"/><circle cx="180" cy="200" r="50" fill="none" stroke="#c9a84c" stroke-width=".5" opacity=".15"/><circle cx="180" cy="200" r="30" fill="none" stroke="#c9a84c" stroke-width=".5" opacity=".1"/><g fill="#8b6914" opacity=".6"><circle cx="160" cy="180" r="5"/><circle cx="190" cy="215" r="5"/><circle cx="170" cy="220" r="4"/><circle cx="200" cy="185" r="4"/><circle cx="155" cy="210" r="4"/></g><line x1="110" y1="200" x2="130" y2="200" stroke="#666" stroke-width="3"/><line x1="230" y1="200" x2="290" y2="200" stroke="#666" stroke-width="3"/><path d="M130 270Q150 250 160 270" fill="url(#rheat)" opacity=".3"/><path d="M160 270Q180 240 200 270" fill="url(#rheat)" opacity=".4"/><path d="M190 270Q210 250 230 270" fill="url(#rheat)" opacity=".3"/><circle cx="430" cy="180" r="55" fill="none" stroke="#444" stroke-width="2"/><circle cx="430" cy="180" r="48" fill="none" stroke="#c9a84c" stroke-width="1" opacity=".3"/><path d="M430 180L410 145" stroke="#e74c3c" stroke-width="2" stroke-linecap="round"/><text x="430" y="148" text-anchor="middle" fill="#e74c3c" font-size="7" font-family="mono">196C</text><text x="430" y="105" text-anchor="middle" fill="#c9a84c" font-size="7" font-family="sans-serif" opacity=".6">First Crack</text><text x="430" y="250" text-anchor="middle" fill="#c9a84c" font-size="7" font-family="sans-serif" opacity=".6">Second Crack 220C+</text><text x="320" y="290" fill="#8b6914" font-size="7" font-family="sans-serif">Drying (30-100C)</text><text x="320" y="305" fill="#a87d2a" font-size="7" font-family="sans-serif">Maillard (150-190C)</text><text x="320" y="320" fill="#c9a84c" font-size="7" font-family="sans-serif">Development (196-220C)</text><text x="320" y="335" fill="#e8c070" font-size="7" font-family="sans-serif">Cooling</text><text x="300" y="350" text-anchor="middle" fill="#c9a84c" font-size="8" opacity=".4" font-family="serif">دورة التحميص</text></svg>`;

// CHERRY — Coffee cherry cross-section
SVG.cherry=`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 720 400"><defs><linearGradient id="gch" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stop-color="#1a1a2e"/><stop offset="100%" stop-color="#0d0d1a"/></linearGradient><radialGradient id="cherryOuter"><stop offset="0%" stop-color="#e85050"/><stop offset="60%" stop-color="#cc2222"/><stop offset="100%" stop-color="#991111"/></radialGradient><radialGradient id="cherryMucilage"><stop offset="0%" stop-color="#f5e6c8"/><stop offset="50%" stop-color="#e8d080"/><stop offset="100%" stop-color="#d4b85a"/></radialGradient><radialGradient id="beamGradL"><stop offset="0%" stop-color="#8b9b4a"/><stop offset="60%" stop-color="#6b8e23"/><stop offset="100%" stop-color="#5a7a1a"/></radialGradient><radialGradient id="beamGradR"><stop offset="0%" stop-color="#7b8b3a"/><stop offset="60%" stop-color="#5b7e13"/><stop offset="100%" stop-color="#4a6a0a"/></radialGradient><linearGradient id="parchGrad" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stop-color="#f0d8a8"/><stop offset="100%" stop-color="#d4b86a"/></linearGradient><filter id="shadow1"><feDropShadow dx="0" dy="2" stdDeviation="3" flood-color="#000" flood-opacity=".5"/></filter></defs><rect width="720" height="400" fill="url(#gch)"/><g stroke="#c9a84c" fill="none" opacity=".06"><circle cx="680" cy="35" r="18"/><circle cx="680" cy="35" r="28"/><circle cx="40" cy="50" r="12"/><circle cx="40" cy="50" r="22"/></g><text x="360" y="28" text-anchor="middle" fill="#c9a84c" font-size="11" opacity=".6" font-family="sans-serif">COFFEE CHERRY ANATOMY — التشريح الموضح لحبة القهوة</text><!-- Cherry silhouette background glow --><ellipse cx="240" cy="200" rx="105" ry="78" fill="#c9a84c" opacity=".03"/><!-- Main cherry outer shape --><path d="M240 120 C110 120 100 190 100 210 C100 280 160 290 240 280 C320 290 380 280 380 210 C380 190 370 120 240 120Z" fill="url(#cherryOuter)" opacity=".85" filter="url(#shadow1)"/><!-- Cutaway surface (flat cut) --><path d="M240 125 C180 130 145 170 145 210 C145 240 170 265 240 275Z" fill="#cc3333" opacity=".3"/><path d="M335 125 C400 130 435 170 435 210 C435 240 410 265 335 275Z" fill="#cc3333" opacity=".2"/><!-- Cross-section interior --><path d="M145 125 C160 130 170 170 170 210 C170 250 160 275 145 278 C130 280 120 260 120 210 C120 160 130 130 145 125Z" fill="url(#cherryMucilage)" opacity=".6"/><path d="M335 125 C320 130 310 170 310 210 C310 250 320 275 335 278 C350 280 360 260 360 210 C360 160 350 130 335 125Z" fill="url(#cherryMucilage)" opacity=".55"/><!-- Parchment layer --><path d="M165 135 C175 140 180 175 180 210 C180 245 175 270 165 275 C155 278 148 260 148 210 C148 160 155 138 165 135Z" fill="url(#parchGrad)" opacity=".6"/><path d="M315 135 C305 140 300 175 300 210 C300 245 305 270 315 275 C325 278 332 260 332 210 C332 160 325 138 315 135Z" fill="url(#parchGrad)" opacity=".55"/><!-- Silver skin --><path d="M178 142 C184 145 187 178 187 210 C187 242 184 265 178 268 C172 270 168 255 168 210 C168 165 172 144 178 142Z" fill="#ccc" opacity=".3"/><path d="M302 142 C296 145 293 178 293 210 C293 242 296 265 302 268 C308 270 312 255 312 210 C312 165 308 144 302 142Z" fill="#ccc" opacity=".25"/><!-- Endosperm (Bean) Left --><path d="M190 150 C200 155 205 188 205 210 C205 240 200 257 190 260 C178 263 175 248 175 210 C175 178 180 153 190 150Z" fill="url(#beamGradL)" opacity=".8"/><path d="M190 150 C195 155 198 188 198 210 C198 240 195 257 190 260 C185 262 183 250 183 210 C183 175 185 152 190 150Z" fill="#9bab5a" opacity=".2"/><!-- Endosperm (Bean) Right --><path d="M290 150 C280 155 275 188 275 210 C275 240 280 257 290 260 C302 263 305 248 305 210 C305 178 300 153 290 150Z" fill="url(#beamGradR)" opacity=".8"/><path d="M290 150 C285 155 282 188 282 210 C282 240 285 257 290 260 C295 262 297 250 297 210 C297 175 295 152 290 150Z" fill="#8b9b4a" opacity=".2"/><!-- Center crack lines --><path d="M237 148 C239 165 240 190 238 210 C236 230 237 255 240 268" stroke="#3a4a0a" stroke-width="1.2" fill="none" opacity=".5"/><path d="M243 148 C241 165 240 190 242 210 C244 230 243 255 240 268" stroke="#3a4a0a" stroke-width="1.2" fill="none" opacity=".5"/><path d="M237 148 C239 165 240 190 238 210 C236 230 237 255 240 268" stroke="#c9a84c" stroke-width=".4" fill="none" opacity=".2"/><!-- Stem --><path d="M240 120 C240 110 235 100 230 90" stroke="#5a7a2a" stroke-width="2.5" fill="none" stroke-linecap="round" opacity=".6"/><ellipse cx="228" cy="88" rx="4" ry="3" fill="#5a7a2a" opacity=".5"/><!-- Dimension line - cherry size --><line x1="90" y1="200" x2="90" y2="120" stroke="#c9a84c" stroke-width=".5" opacity=".35" stroke-dasharray="2,2"/><line x1="85" y1="120" x2="95" y2="120" stroke="#c9a84c" stroke-width=".5" opacity=".35"/><line x1="85" y1="200" x2="95" y2="200" stroke="#c9a84c" stroke-width=".5" opacity=".35"/><text x="80" y="168" text-anchor="end" fill="#c9a84c" font-size="6" font-family="sans-serif" opacity=".5" transform="rotate(-90,80,168)">~15-18mm</text><!-- Dimension line - bean size --><line x1="395" y1="190" x2="395" y2="150" stroke="#c9a84c" stroke-width=".5" opacity=".35" stroke-dasharray="2,2"/><line x1="390" y1="150" x2="400" y2="150" stroke="#c9a84c" stroke-width=".5" opacity=".35"/><line x1="390" y1="190" x2="400" y2="190" stroke="#c9a84c" stroke-width=".5" opacity=".35"/><text x="405" y="174" fill="#c9a84c" font-size="6" font-family="sans-serif" opacity=".5">~10-12mm</text><!-- Labels with leader lines (Left side - English) --><g><line x1="130" y1="128" x2="70" y2="80" stroke="#c9a84c" stroke-width=".7" opacity=".5"/><circle cx="130" cy="128" r="2" fill="#c9a84c" opacity=".5"/><text x="68" y="76" text-anchor="end" fill="#e85050" font-size="8" font-family="sans-serif" font-weight="bold">Exocarp (Outer Skin)</text></g><g><line x1="152" y1="148" x2="72" y2="108" stroke="#e8c070" stroke-width=".7" opacity=".5"/><circle cx="152" cy="148" r="2" fill="#e8c070" opacity=".5"/><text x="70" y="104" text-anchor="end" fill="#e8c070" font-size="8" font-family="sans-serif">Mucilage / Pulp</text></g><g><line x1="172" y1="168" x2="72" y2="168" stroke="#d4b86a" stroke-width=".7" opacity=".5"/><circle cx="172" cy="168" r="2" fill="#d4b86a" opacity=".5"/><text x="70" y="165" text-anchor="end" fill="#d4b86a" font-size="8" font-family="sans-serif">Parchment</text></g><g><line x1="185" y1="188" x2="72" y2="210" stroke="#aaa" stroke-width=".7" opacity=".5"/><circle cx="185" cy="188" r="2" fill="#aaa" opacity=".5"/><text x="70" y="208" text-anchor="end" fill="#aaa" font-size="8" font-family="sans-serif">Silver Skin</text></g><g><line x1="198" y1="210" x2="72" y2="252" stroke="#8b9b4a" stroke-width=".7" opacity=".5"/><circle cx="198" cy="210" r="2" fill="#8b9b4a" opacity=".5"/><text x="70" y="248" text-anchor="end" fill="#8b9b4a" font-size="8" font-family="sans-serif">Endosperm (Bean)</text></g><!-- Labels with leader lines (Right side - Arabic) --><g><line x1="330" y1="130" x2="430" y2="76" stroke="#c9a84c" stroke-width=".7" opacity=".5"/><circle cx="330" cy="130" r="2" fill="#c9a84c" opacity=".5"/><text x="432" y="74" fill="#e85050" font-size="8" font-family="sans-serif" font-weight="bold">القشرة الخارجية</text></g><g><line x1="310" y1="150" x2="428" y2="110" stroke="#e8c070" stroke-width=".7" opacity=".5"/><circle cx="310" cy="150" r="2" fill="#e8c070" opacity=".5"/><text x="430" y="108" fill="#e8c070" font-size="8" font-family="sans-serif">اللب / المنجة</text></g><g><line x1="300" y1="170" x2="428" y2="170" stroke="#d4b86a" stroke-width=".7" opacity=".5"/><circle cx="300" cy="170" r="2" fill="#d4b86a" opacity=".5"/><text x="430" y="167" fill="#d4b86a" font-size="8" font-family="sans-serif">الرقاق التشميري</text></g><g><line x1="295" y1="190" x2="428" y2="215" stroke="#aaa" stroke-width=".7" opacity=".5"/><circle cx="295" cy="190" r="2" fill="#aaa" opacity=".5"/><text x="430" y="213" fill="#aaa" font-size="8" font-family="sans-serif">القشرة الفضية</text></g><g><line x1="282" y1="210" x2="428" y2="255" stroke="#8b9b4a" stroke-width=".7" opacity=".5"/><circle cx="282" cy="210" r="2" fill="#8b9b4a" opacity=".5"/><text x="430" y="253" fill="#8b9b4a" font-size="8" font-family="sans-serif">الاندوسبرم (البذرة)</text></g><!-- Legend box at bottom --><rect x="240" y="305" width="240" height="36" rx="4" fill="none" stroke="#c9a84c" stroke-width=".4" opacity=".25"/><text x="360" y="318" text-anchor="middle" fill="#c9a84c" font-size="7" font-family="sans-serif" opacity=".5">تحتوي الكرزة على بذرتين من البن (+15% تحتوي على بذرة واحدة)</text><text x="360" y="332" text-anchor="middle" fill="#c9a84c" font-size="7" font-family="sans-serif" opacity=".4">Each cherry contains two seeds (~15% have one) • الحبة الواحدة = فنجان قهوة</text><line x1="140" y1="140" x2="80" y2="100" stroke="#e8c070" stroke-width=".8" opacity=".6"/><text x="80" y="95" text-anchor="end" fill="#e8c070" font-size="8" font-family="sans-serif">Mucilage (Pulp)</text><line x1="130" y1="175" x2="70" y2="170" stroke="#f5e6c8" stroke-width=".8" opacity=".6"/><text x="70" y="168" text-anchor="end" fill="#f5e6c8" font-size="8" font-family="sans-serif">Parchment</text><line x1="115" y1="195" x2="50" y2="200" stroke="#8b6914" stroke-width=".8" opacity=".6"/><text x="50" y="198" text-anchor="end" fill="#8b6914" font-size="8" font-family="sans-serif">Silver Skin</text><line x1="115" y1="215" x2="50" y2="235" stroke="#c9a84c" stroke-width=".8" opacity=".6"/><text x="50" y="233" text-anchor="end" fill="#c9a84c" font-size="8" font-family="sans-serif">Endosperm (Bean)</text><line x1="245" y1="195" x2="360" y2="175" stroke="#8b6914" stroke-width=".8" opacity=".6"/><text x="360" y="173" fill="#8b6914" font-size="8" font-family="sans-serif">Flat side</text><line x1="260" y1="205" x2="360" y2="210" stroke="#8b6914" stroke-width=".8" opacity=".6"/><text x="360" y="208" fill="#8b6914" font-size="8" font-family="sans-serif">Center cut</text><text x="300" y="345" text-anchor="middle" fill="#c9a84c" font-size="9" opacity=".4" font-family="serif">تشريح ثمرة القهوة</text></svg>`;

// ARABUSTA — Arabica vs Robusta comparison
SVG.arabusta='<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 700 400"><defs><linearGradient id="gar" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stop-color="#1a1a2e"/><stop offset="100%" stop-color="#0d0d1a"/></linearGradient><radialGradient id="arabBean"><stop offset="0%" stop-color="#a0805a"/><stop offset="60%" stop-color="#7a6040"/><stop offset="100%" stop-color="#5a4028"/></radialGradient><radialGradient id="robBean"><stop offset="0%" stop-color="#6a4a2a"/><stop offset="60%" stop-color="#4a2a0a"/><stop offset="100%" stop-color="#2a1a00"/></radialGradient><filter id="sha2"><feDropShadow dx="0" dy="2" stdDeviation="3" flood-color="#000" flood-opacity=".5"/></filter></defs><rect width="700" height="400" fill="url(#gar)"/><g stroke="#c9a84c" fill="none" opacity=".06"><circle cx="660" cy="35" r="18"/><circle cx="660" cy="35" r="28"/><circle cx="40" cy="50" r="12"/><circle cx="40" cy="50" r="22"/></g><text x="350" y="28" text-anchor="middle" fill="#c9a84c" font-size="11" opacity=".6" font-family="sans-serif">ARABICA vs ROBUSTA — Key Differences / الفروقات الرئيسية</text><!-- Gold divider --><line x1="350" y1="42" x2="350" y2="370" stroke="#c9a84c" stroke-width=".6" opacity=".3" stroke-dasharray="4,3"/><text x="350" y="55" text-anchor="middle" fill="#c9a84c" font-size="7" font-family="sans-serif" opacity=".35" transform="rotate(-90,350,55)">VS</text><!-- LEFT: Arabica --><text x="175" y="65" text-anchor="middle" fill="#c9a84c" font-size="13" font-family="serif">Arabica</text><text x="175" y="80" text-anchor="middle" fill="#c9a84c" font-size="7" font-family="sans-serif" opacity=".5">أرابيكا</text><!-- Arabica bean shape --><path d="M175 110 C140 110 120 140 120 170 C120 200 140 230 175 230 C210 230 230 200 230 170 C230 140 210 110 175 110Z" fill="url(#arabBean)" opacity=".85" filter="url(#sha2)"/><!-- Arabica center crack (S-curve) --><path d="M185 125 C175 145 195 165 175 185 C165 195 175 210 185 215" stroke="#3a2a10" stroke-width="1.5" fill="none" opacity=".5"/><path d="M185 125 C175 145 195 165 175 185 C165 195 175 210 185 215" stroke="#c9a84c" stroke-width=".3" fill="none" opacity=".2"/><!-- Arabica dimension --><line x1="105" y1="170" x2="105" y2="120" stroke="#c9a84c" stroke-width=".4" opacity=".3" stroke-dasharray="2,2"/><line x1="100" y1="120" x2="110" y2="120" stroke="#c9a84c" stroke-width=".4" opacity=".3"/><line x1="100" y1="170" x2="110" y2="170" stroke="#c9a84c" stroke-width=".4" opacity=".3"/><text x="95" y="148" text-anchor="end" fill="#c9a84c" font-size="5" font-family="sans-serif" opacity=".4" transform="rotate(-90,95,148)">~12mm</text><!-- Arabica traits --><text x="175" y="255" text-anchor="middle" fill="#5a7a3a" font-size="7" font-family="sans-serif">Altitude: 900-2000m</text><text x="175" y="268" text-anchor="middle" fill="#c9a84c" font-size="7" font-family="sans-serif">Caffeine: ~1.2%</text><text x="175" y="281" text-anchor="middle" fill="#aaa" font-size="7" font-family="sans-serif">Shape: Oval / بيضاوية</text><text x="175" y="298" text-anchor="middle" fill="#e8c070" font-size="8" font-family="serif">Smooth, Sweet, Complex</text><text x="175" y="312" text-anchor="middle" fill="#e8c070" font-size="7" font-family="sans-serif" opacity=".6">ناعمة، حلوة، معقدة</text><!-- RIGHT: Robusta --><text x="525" y="65" text-anchor="middle" fill="#c9a84c" font-size="13" font-family="serif">Robusta</text><text x="525" y="80" text-anchor="middle" fill="#c9a84c" font-size="7" font-family="sans-serif" opacity=".5">روبوستا</text><!-- Robusta bean shape --><path d="M525 115 C500 115 480 140 480 165 C480 190 500 220 525 220 C550 220 570 190 570 165 C570 140 550 115 525 115Z" fill="url(#robBean)" opacity=".85" filter="url(#sha2)"/><!-- Robusta center crack (straight) --><line x1="525" y1="130" x2="525" y2="205" stroke="#1a0a00" stroke-width="1.5" opacity=".5"/><line x1="525" y1="130" x2="525" y2="205" stroke="#c9a84c" stroke-width=".3" opacity=".2"/><!-- Robusta dimension --><line x1="582" y1="165" x2="582" y2="125" stroke="#c9a84c" stroke-width=".4" opacity=".3" stroke-dasharray="2,2"/><line x1="577" y1="125" x2="587" y2="125" stroke="#c9a84c" stroke-width=".4" opacity=".3"/><line x1="577" y1="165" x2="587" y2="165" stroke="#c9a84c" stroke-width=".4" opacity=".3"/><text x="592" y="148" fill="#c9a84c" font-size="5" font-family="sans-serif" opacity=".4" transform="rotate(-90,592,148)">~10mm</text><!-- Robusta traits --><text x="525" y="255" text-anchor="middle" fill="#5a7a3a" font-size="7" font-family="sans-serif">Altitude: 200-900m</text><text x="525" y="268" text-anchor="middle" fill="#c9a84c" font-size="7" font-family="sans-serif">Caffeine: ~2.2%</text><text x="525" y="281" text-anchor="middle" fill="#aaa" font-size="7" font-family="sans-serif">Shape: Round / دائرية</text><text x="525" y="298" text-anchor="middle" fill="#e8c070" font-size="8" font-family="serif">Strong, Bitter, Earthy</text><text x="525" y="312" text-anchor="middle" fill="#e8c070" font-size="7" font-family="sans-serif" opacity=".6">قوية، مرة، ترابية</text><!-- Bottom note --><text x="350" y="360" text-anchor="middle" fill="#c9a84c" font-size="7" font-family="sans-serif" opacity=".4">Arabica = 60-70% of world production • Robusta = 30-40%</text></svg>';

// ROAST — Roast levels comparison
SVG.roastLevels='<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 700 400"><defs><linearGradient id="grl" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stop-color="#1a1a2e"/><stop offset="100%" stop-color="#0d0d1a"/></linearGradient><radialGradient id="lightBean"><stop offset="0%" stop-color="#e0cd8a"/><stop offset="50%" stop-color="#c9a85a"/><stop offset="100%" stop-color="#b08a3a"/></radialGradient><radialGradient id="medBean"><stop offset="0%" stop-color="#a0804a"/><stop offset="50%" stop-color="#7a6030"/><stop offset="100%" stop-color="#5a4020"/></radialGradient><radialGradient id="darkBean"><stop offset="0%" stop-color="#5a3a1a"/><stop offset="50%" stop-color="#3d1c00"/><stop offset="100%" stop-color="#1a0a00"/></radialGradient><filter id="sha3"><feDropShadow dx="0" dy="2" stdDeviation="3" flood-color="#000" flood-opacity=".5"/></filter></defs><rect width="700" height="400" fill="url(#grl)"/><g stroke="#c9a84c" fill="none" opacity=".06"><circle cx="660" cy="35" r="18"/><circle cx="660" cy="35" r="28"/><circle cx="40" cy="50" r="12"/><circle cx="40" cy="50" r="22"/></g><text x="350" y="28" text-anchor="middle" fill="#c9a84c" font-size="11" opacity=".6" font-family="sans-serif">ROAST LEVELS — Light &rarr; Medium &rarr; Dark / درجة التحميص</text><!-- Thermometer on the right --><rect x="620" y="60" width="8" height="260" rx="4" fill="none" stroke="#c9a84c" stroke-width=".5" opacity=".35"/><circle cx="624" cy="320" r="10" fill="none" stroke="#c9a84c" stroke-width=".5" opacity=".35"/><circle cx="624" cy="320" r="4" fill="#e85050" opacity=".6"/><!-- Temperature markers --><line x1="632" y1="100" x2="642" y2="100" stroke="#c9a84c" stroke-width=".4" opacity=".3"/><text x="644" y="103" fill="#c9a84c" font-size="5" font-family="sans-serif" opacity=".4">196C</text><line x1="632" y1="180" x2="642" y2="180" stroke="#c9a84c" stroke-width=".4" opacity=".3"/><text x="644" y="183" fill="#c9a84c" font-size="5" font-family="sans-serif" opacity=".4">210C</text><line x1="632" y1="260" x2="642" y2="260" stroke="#c9a84c" stroke-width=".4" opacity=".3"/><text x="644" y="263" fill="#c9a84c" font-size="5" font-family="sans-serif" opacity=".4">225C</text><!-- Mercury fill --><rect x="622" y="265" width="4" height="55" rx="2" fill="#e85050" opacity=".4"/><rect x="622" y="185" width="4" height="80" rx="2" fill="#e85050" opacity=".2"/><rect x="622" y="105" width="4" height="80" rx="2" fill="#e85050" opacity=".1"/><!-- LEFT: Light Roast --><text x="140" y="65" text-anchor="middle" fill="#e0cd8a" font-size="10" font-family="serif">Light Roast</text><text x="140" y="80" text-anchor="middle" fill="#c9a84c" font-size="7" font-family="sans-serif" opacity=".5">تحميص فاتح</text><path d="M140 110 C115 110 100 135 100 160 C100 185 115 210 140 210 C165 210 180 185 180 160 C180 135 165 110 140 110Z" fill="url(#lightBean)" opacity=".85" filter="url(#sha3)"/><path d="M150 120 C140 140 160 155 145 175 C135 190 150 200 155 205" stroke="#8a6a2a" stroke-width="1.2" fill="none" opacity=".3"/><text x="140" y="235" text-anchor="middle" fill="#c9a84c" font-size="7" font-family="sans-serif">~196C / First Crack</text><text x="140" y="250" text-anchor="middle" fill="#c9a84c" font-size="7" font-family="sans-serif" opacity=".5">8-9 minutes</text><text x="140" y="268" text-anchor="middle" fill="#e0cd8a" font-size="7" font-family="serif">High acidity, fruity</text><text x="140" y="282" text-anchor="middle" fill="#e0cd8a" font-size="6" font-family="sans-serif" opacity=".6">حموضة عالية، فاكهي</text><!-- MIDDLE: Medium Roast --><text x="350" y="65" text-anchor="middle" fill="#c9a85a" font-size="10" font-family="serif">Medium Roast</text><text x="350" y="80" text-anchor="middle" fill="#c9a84c" font-size="7" font-family="sans-serif" opacity=".5">تحميص متوسط</text><path d="M350 110 C325 110 310 135 310 160 C310 185 325 210 350 210 C375 210 390 185 390 160 C390 135 375 110 350 110Z" fill="url(#medBean)" opacity=".85" filter="url(#sha3)"/><path d="M360 120 C350 140 370 155 355 175 C345 190 360 200 365 205" stroke="#3a2a10" stroke-width="1.2" fill="none" opacity=".4"/><text x="350" y="235" text-anchor="middle" fill="#c9a84c" font-size="7" font-family="sans-serif">~210C / Between Cracks</text><text x="350" y="250" text-anchor="middle" fill="#c9a84c" font-size="7" font-family="sans-serif" opacity=".5">9-11 minutes</text><text x="350" y="268" text-anchor="middle" fill="#c9a85a" font-size="7" font-family="serif">Balanced, sweet</text><text x="350" y="282" text-anchor="middle" fill="#c9a85a" font-size="6" font-family="sans-serif" opacity=".6">متوازن، حلو</text><!-- RIGHT: Dark Roast --><text x="560" y="65" text-anchor="middle" fill="#5a3a1a" font-size="10" font-family="serif">Dark Roast</text><text x="560" y="80" text-anchor="middle" fill="#c9a84c" font-size="7" font-family="sans-serif" opacity=".5">تحميص غامق</text><path d="M560 110 C535 110 520 135 520 160 C520 185 535 210 560 210 C585 210 600 185 600 160 C600 135 585 110 560 110Z" fill="url(#darkBean)" opacity=".85" filter="url(#sha3)"/><path d="M570 120 C560 140 580 155 565 175 C555 190 570 200 575 205" stroke="#000" stroke-width="1.2" fill="none" opacity=".6"/><text x="560" y="235" text-anchor="middle" fill="#c9a84c" font-size="7" font-family="sans-serif">~225C+ / Second Crack</text><text x="560" y="250" text-anchor="middle" fill="#c9a84c" font-size="7" font-family="sans-serif" opacity=".5">11-14 minutes</text><text x="560" y="268" text-anchor="middle" fill="#8a6a4a" font-size="7" font-family="serif">Low acidity, bold</text><text x="560" y="282" text-anchor="middle" fill="#8a6a4a" font-size="6" font-family="sans-serif" opacity=".6">حموضة منخفضة، جريء</text><!-- Arrow between stages --><path d="M195 160 L295 160" stroke="#c9a84c" stroke-width=".6" opacity=".3" marker-end="url(#arr)"/><path d="M405 160 L505 160" stroke="#c9a84c" stroke-width=".6" opacity=".3" marker-end="url(#arr)"/><defs><marker id="arr" markerWidth="6" markerHeight="6" refX="5" refY="3" orient="auto"><path d="M0 0 L6 3 L0 6Z" fill="#c9a84c" opacity=".3"/></marker></defs></svg>';

// ESPRESSO — Espresso extraction detail
SVG.espressoShot=`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 600 350"><defs><linearGradient id="ges" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stop-color="#1a1a2e"/><stop offset="100%" stop-color="#0d0d1a"/></linearGradient><linearGradient id="crm" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stop-color="#e8c070"/><stop offset="40%" stop-color="#c8923a"/><stop offset="100%" stop-color="#8b4513"/></linearGradient></defs><rect width="600" height="350" fill="url(#ges)"/><g stroke="#c9a84c" fill="none" opacity=".06"><circle cx="560" cy="35" r="15"/><circle cx="560" cy="35" r="25"/></g><text x="300" y="28" text-anchor="middle" fill="#c9a84c" font-size="11" opacity=".6" font-family="sans-serif">ESPRESSO EXTRACTION — Anatomy of the Perfect Shot</text><rect x="240" y="60" width="120" height="14" rx="4" fill="#555"/><rect x="270" y="74" width="60" height="6" rx="2" fill="#666"/><path d="M220 80L380 80Q390 80 390 88L380 100H220L210 88Q210 80 220 80Z" fill="#333" stroke="#555" stroke-width="1"/><ellipse cx="300" cy="85" rx="36" ry="5" fill="#3d2a1a" opacity=".8"/><ellipse cx="300" cy="85" rx="30" ry="4" fill="#5a3a1a" opacity=".6"/><text x="300" y="65" text-anchor="middle" fill="#6af" font-size="7" font-family="mono">9 bar</text><path d="M290 90L295 115" stroke="#c9a84c" stroke-width="1.5" opacity=".4"/><path d="M305 90L310 115" stroke="#c9a84c" stroke-width="1.5" opacity=".4"/><path d="M300 90L300 120" stroke="#c9a84c" stroke-width="2" opacity=".5"/><path d="M245 145L265 280L335 280L355 145Z" fill="none" stroke="#c9a84c" stroke-width="1.5" opacity=".5"/><ellipse cx="300" cy="145" rx="55" ry="8" fill="none" stroke="#c9a84c" stroke-width="1.5" opacity=".5"/><ellipse cx="300" cy="245" rx="36" ry="6" fill="url(#crm)" opacity=".7"/><ellipse cx="300" cy="240" rx="28" ry="4" fill="#e8c070" opacity=".8"/><text x="300" y="248" text-anchor="middle" fill="#fff" font-size="7" font-family="mono" opacity=".9">Crema</text><text x="440" y="110" fill="#c9a84c" font-size="8" font-family="sans-serif" font-weight="bold">Perfect Shot:</text><text x="440" y="125" fill="#aaa" font-size="7" font-family="sans-serif">25-30 sec</text><text x="440" y="140" fill="#aaa" font-size="7" font-family="sans-serif">36-45g yield</text><text x="440" y="155" fill="#aaa" font-size="7" font-family="sans-serif">18-20g dose</text><text x="440" y="170" fill="#aaa" font-size="7" font-family="sans-serif">92-96C</text><text x="440" y="185" fill="#aaa" font-size="7" font-family="sans-serif">9 bar pressure</text><text x="440" y="205" fill="#e8c070" font-size="7" font-family="sans-serif">Golden crema 3-5mm</text><text x="300" y="340" text-anchor="middle" fill="#c9a84c" font-size="9" opacity=".4" font-family="serif">استخلاص الإسبريسو</text></svg>`;

// LATTE — Latte art techniques
SVG.latteArt=`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 600 350"><defs><linearGradient id="glt" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stop-color="#1a1a2e"/><stop offset="100%" stop-color="#0d0d1a"/></linearGradient><radialGradient id="cup1"><stop offset="0%" stop-color="#f5e6c8"/><stop offset="40%" stop-color="#e8d5a3"/><stop offset="100%" stop-color="#c9a84c"/></radialGradient></defs><rect width="600" height="350" fill="url(#glt)"/><g stroke="#c9a84c" fill="none" opacity=".06"><circle cx="560" cy="35" r="15"/><circle cx="560" cy="35" r="25"/></g><text x="300" y="28" text-anchor="middle" fill="#c9a84c" font-size="11" opacity=".6" font-family="sans-serif">LATTE ART — Pouring Techniques</text><ellipse cx="130" cy="190" rx="45" ry="30" fill="#2a1a0a" stroke="#c9a84c" stroke-width="1" opacity=".7"/><ellipse cx="130" cy="185" rx="30" ry="18" fill="url(#cup1)" opacity=".3"/><path d="M115 185Q120 170 130 180Q140 170 145 185Q150 195 130 205Q110 195 115 185Z" fill="#fff" opacity=".7"/><text x="130" y="235" text-anchor="middle" fill="#c9a84c" font-size="8" font-family="sans-serif">Heart</text><ellipse cx="300" cy="190" rx="45" ry="30" fill="#2a1a0a" stroke="#c9a84c" stroke-width="1" opacity=".7"/><ellipse cx="300" cy="185" rx="30" ry="18" fill="url(#cup1)" opacity=".3"/><path d="M270 195Q275 175 280 190Q285 170 290 185Q295 168 300 180Q305 168 310 185Q315 170 320 190Q325 175 330 195" fill="none" stroke="#fff" stroke-width="2.5" opacity=".7" stroke-linecap="round"/><line x1="300" y1="180" x2="300" y2="200" stroke="#fff" stroke-width="2" opacity=".7" stroke-linecap="round"/><text x="300" y="235" text-anchor="middle" fill="#c9a84c" font-size="8" font-family="sans-serif">Rosetta</text><ellipse cx="470" cy="190" rx="45" ry="30" fill="#2a1a0a" stroke="#c9a84c" stroke-width="1" opacity=".7"/><ellipse cx="470" cy="185" rx="30" ry="18" fill="url(#cup1)" opacity=".3"/><circle cx="460" cy="180" r="5" fill="#fff" opacity=".7"/><circle cx="480" cy="180" r="5" fill="#fff" opacity=".7"/><circle cx="470" cy="190" r="6" fill="#fff" opacity=".7"/><circle cx="470" cy="200" r="7" fill="#fff" opacity=".7"/><text x="470" y="235" text-anchor="middle" fill="#c9a84c" font-size="8" font-family="sans-serif">Tulip</text><text x="300" y="275" text-anchor="middle" fill="#aaa" font-size="7" font-family="sans-serif">Milk: 55-65C | Stretch Spin Tap Pour</text><text x="300" y="290" text-anchor="middle" fill="#888" font-size="7" font-family="sans-serif">Whole milk is best for latte art (3.25-3.5% fat)</text><text x="300" y="340" text-anchor="middle" fill="#c9a84c" font-size="9" opacity=".4" font-family="serif">فن اللاتيه</text></svg>`;

// FILTER — Water filtration system
SVG.waterFilter=`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 600 350"><defs><linearGradient id="gwf" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stop-color="#0d1a2e"/><stop offset="100%" stop-color="#1a1a2e"/></linearGradient></defs><rect width="600" height="350" fill="url(#gwf)"/><g stroke="#c9a84c" fill="none" opacity=".06"><circle cx="560" cy="35" r="15"/><circle cx="560" cy="35" r="25"/></g><text x="300" y="28" text-anchor="middle" fill="#c9a84c" font-size="11" opacity=".6" font-family="sans-serif">WATER FILTRATION — From Tap to Perfect Cup</text><rect x="40" y="80" width="120" height="60" rx="8" fill="#1a1a28" stroke="#c9a84c" stroke-width=".8" opacity=".5"/><text x="100" y="103" text-anchor="middle" fill="#c9a84c" font-size="9" font-family="sans-serif" font-weight="bold">Activated Carbon</text><text x="100" y="120" text-anchor="middle" fill="#aaa" font-size="7" font-family="sans-serif">Removes chlorine,</text><text x="100" y="133" text-anchor="middle" fill="#aaa" font-size="7" font-family="sans-serif">odors, taste</text><path d="M160 110L190 110" stroke="#c9a84c" stroke-width="1.5" opacity=".5"/><polygon points="190,105 200,110 190,115" fill="#c9a84c" opacity=".5"/><rect x="210" y="80" width="120" height="60" rx="8" fill="#1a1a28" stroke="#c9a84c" stroke-width=".8" opacity=".5"/><text x="270" y="103" text-anchor="middle" fill="#c9a84c" font-size="9" font-family="sans-serif" font-weight="bold">Ion Exchange</text><text x="270" y="120" text-anchor="middle" fill="#aaa" font-size="7" font-family="sans-serif">Adjusts hardness</text><text x="270" y="133" text-anchor="middle" fill="#aaa" font-size="7" font-family="sans-serif">and alkalinity</text><path d="M330 110L360 110" stroke="#c9a84c" stroke-width="1.5" opacity=".5"/><polygon points="360,105 370,110 360,115" fill="#c9a84c" opacity=".5"/><rect x="380" y="80" width="120" height="60" rx="8" fill="#1a1a28" stroke="#c9a84c" stroke-width=".8" opacity=".5"/><text x="440" y="103" text-anchor="middle" fill="#c9a84c" font-size="9" font-family="sans-serif" font-weight="bold">RO + Remin</text><text x="440" y="120" text-anchor="middle" fill="#aaa" font-size="7" font-family="sans-serif">Full control</text><text x="440" y="133" text-anchor="middle" fill="#aaa" font-size="7" font-family="sans-serif">Expensive</text><rect x="210" y="180" width="180" height="50" rx="10" fill="#0d2d1a" stroke="#3a7a33" stroke-width="1.5" opacity=".7"/><text x="300" y="203" text-anchor="middle" fill="#3a7a33" font-size="10" font-family="sans-serif" font-weight="bold">Optimal Water</text><text x="300" y="220" text-anchor="middle" fill="#aaa" font-size="7" font-family="sans-serif">TDS 150-175 ppm | pH 6.5-7.5</text><path d="M270 180L270 140L300 140" stroke="#6af" stroke-width="1" opacity=".4"/><path d="M330 180L330 140L300 140" stroke="#6af" stroke-width="1" opacity=".4"/><text x="300" y="265" text-anchor="middle" fill="#aaa" font-size="8" font-family="sans-serif">Recommended: Carbon filter + Ion exchange for most cafes</text><text x="300" y="340" text-anchor="middle" fill="#c9a84c" font-size="9" opacity=".4" font-family="serif">تنقية المياه</text></svg>`;

// TDS — TDS / Refractometer measurement
SVG.tdsMeter=`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 600 350"><defs><linearGradient id="gtds" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stop-color="#1a1a2e"/><stop offset="100%" stop-color="#0d0d1a"/></linearGradient></defs><rect width="600" height="350" fill="url(#gtds)"/><g stroke="#c9a84c" fill="none" opacity=".06"><circle cx="560" cy="35" r="15"/><circle cx="560" cy="35" r="25"/></g><text x="300" y="28" text-anchor="middle" fill="#c9a84c" font-size="11" opacity=".6" font-family="sans-serif">TDS and REFRACTOMETER — Measuring Extraction</text><rect x="100" y="80" width="120" height="50" rx="6" fill="#2a2a3a" stroke="#666" stroke-width="1"/><rect x="105" y="85" width="70" height="20" rx="3" fill="#1a1a28"/><text x="140" y="98" text-anchor="middle" fill="#6af" font-size="7" font-family="mono">1.35%</text><circle cx="200" cy="105" r="8" fill="#333" stroke="#555" stroke-width="1"/><rect x="190" y="130" width="40" height="10" rx="2" fill="#333" stroke="#555" stroke-width=".5"/><ellipse cx="140" cy="150" rx="20" ry="10" fill="#c9a84c" opacity=".1"/><text x="160" y="165" text-anchor="middle" fill="#aaa" font-size="7" font-family="sans-serif">Refractometer</text><rect x="300" y="100" width="250" height="30" rx="4" fill="#1a1a28" stroke="#444" stroke-width="1"/><rect x="300" y="100" width="60" height="30" rx="4" fill="#8b3a1a" opacity=".6"/><rect x="360" y="100" width="50" height="30" fill="#3a7a33" opacity=".6"/><rect x="410" y="100" width="50" height="30" fill="#3a7a33" opacity=".6"/><rect x="460" y="100" width="50" height="30" fill="#c9a84c" opacity=".4"/><rect x="510" y="100" width="40" height="30" rx="4" fill="#8b3a1a" opacity=".6"/><text x="330" y="120" text-anchor="middle" fill="#fff" font-size="6" font-family="mono">Weak</text><text x="385" y="120" text-anchor="middle" fill="#fff" font-size="6" font-family="mono">S</text><text x="435" y="120" text-anchor="middle" fill="#fff" font-size="6" font-family="mono">O</text><text x="485" y="120" text-anchor="middle" fill="#fff" font-size="6" font-family="mono">D</text><text x="530" y="120" text-anchor="middle" fill="#fff" font-size="6" font-family="mono">Bitter</text><text x="425" y="85" text-anchor="middle" fill="#27ae60" font-size="8" font-family="sans-serif" font-weight="bold">Sweet Spot 18-22%</text><rect x="360" y="160" width="200" height="50" rx="6" fill="#1a1a28" stroke="#444" stroke-width=".5"/><text x="460" y="178" text-anchor="middle" fill="#c9a84c" font-size="8" font-family="mono">Extraction Yield = TDS x Yield / Dose</text><text x="460" y="195" text-anchor="middle" fill="#aaa" font-size="7" font-family="mono">Example: 1.35% x 250g / 18g = 18.75%</text><text x="300" y="340" text-anchor="middle" fill="#c9a84c" font-size="9" opacity=".4" font-family="serif">قياس TDS</text></svg>`;

// CUPPING — Cupping evaluation station
SVG.cuppingSetup=`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 600 350"><defs><linearGradient id="gcup" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stop-color="#1a1a2e"/><stop offset="100%" stop-color="#0d0d1a"/></linearGradient></defs><rect width="600" height="350" fill="url(#gcup)"/><g stroke="#c9a84c" fill="none" opacity=".06"><circle cx="560" cy="35" r="15"/><circle cx="560" cy="35" r="25"/></g><text x="300" y="28" text-anchor="middle" fill="#c9a84c" font-size="11" opacity=".6" font-family="sans-serif">CUPPING STATION — Professional Evaluation Setup</text><rect x="40" y="220" width="520" height="8" rx="2" fill="#2a2a3a" opacity=".5"/><rect x="80" y="228" width="8" height="50" fill="#2a2a3a" opacity=".5"/><rect x="510" y="228" width="8" height="50" fill="#2a2a3a" opacity=".5"/><ellipse cx="120" cy="180" rx="30" ry="14" fill="#2a1a0a" stroke="#c9a84c" stroke-width=".8" opacity=".7"/><ellipse cx="120" cy="175" rx="22" ry="8" fill="#3d2a1a" opacity=".6"/><ellipse cx="240" cy="180" rx="30" ry="14" fill="#2a1a0a" stroke="#c9a84c" stroke-width=".8" opacity=".7"/><ellipse cx="240" cy="175" rx="22" ry="8" fill="#3d2a1a" opacity=".6"/><ellipse cx="360" cy="180" rx="30" ry="14" fill="#2a1a0a" stroke="#c9a84c" stroke-width=".8" opacity=".7"/><ellipse cx="360" cy="175" rx="22" ry="8" fill="#3d2a1a" opacity=".6"/><ellipse cx="480" cy="180" rx="30" ry="14" fill="#2a1a0a" stroke="#c9a84c" stroke-width=".8" opacity=".7"/><ellipse cx="480" cy="175" rx="22" ry="8" fill="#3d2a1a" opacity=".6"/><rect x="105" y="145" width="8" height="30" rx="3" fill="#aaa" opacity=".6"/><ellipse cx="109" cy="143" rx="8" ry="5" fill="#c9a84c" opacity=".5"/><rect x="225" y="145" width="8" height="30" rx="3" fill="#aaa" opacity=".6"/><ellipse cx="229" cy="143" rx="8" ry="5" fill="#c9a84c" opacity=".5"/><rect x="345" y="145" width="8" height="30" rx="3" fill="#aaa" opacity=".6"/><ellipse cx="349" cy="143" rx="8" ry="5" fill="#c9a84c" opacity=".5"/><rect x="465" y="145" width="8" height="30" rx="3" fill="#aaa" opacity=".6"/><ellipse cx="469" cy="143" rx="8" ry="5" fill="#c9a84c" opacity=".5"/><rect x="460" y="270" width="100" height="60" rx="3" fill="#1a1a28" stroke="#444" stroke-width=".5"/><text x="510" y="285" text-anchor="middle" fill="#c9a84c" font-size="7" font-family="sans-serif">SCA Score</text><line x1="470" y1="290" x2="550" y2="290" stroke="#444" stroke-width=".5"/><text x="478" y="302" fill="#aaa" font-size="6" font-family="mono">Aroma /10</text><text x="478" y="314" fill="#aaa" font-size="6" font-family="mono">Flavor /10</text><text x="478" y="326" fill="#aaa" font-size="6" font-family="mono">Acidity /10</text><text x="300" y="340" text-anchor="middle" fill="#c9a84c" font-size="9" opacity=".4" font-family="serif">الكبينج — تقييم احترافي</text></svg>`;

// CAFE — Cafe floor plan layout
SVG.cafeLayout=`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 600 350"><defs><linearGradient id="gcl" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stop-color="#1a1a2e"/><stop offset="100%" stop-color="#0d0d1a"/></linearGradient></defs><rect width="600" height="350" fill="url(#gcl)"/><g stroke="#c9a84c" fill="none" opacity=".06"><circle cx="560" cy="35" r="15"/><circle cx="560" cy="35" r="25"/></g><text x="300" y="28" text-anchor="middle" fill="#c9a84c" font-size="11" opacity=".6" font-family="sans-serif">CAFE LAYOUT — Workflow and Flow Efficiency</text><rect x="40" y="50" width="520" height="250" rx="6" fill="none" stroke="#444" stroke-width="1.5"/><rect x="40" y="50" width="520" height="250" rx="6" fill="none" stroke="#c9a84c" stroke-width=".3" opacity=".3"/><rect x="60" y="60" width="200" height="50" rx="4" fill="#2a2a3a" stroke="#555" stroke-width=".8"/><text x="160" y="85" text-anchor="middle" fill="#c9a84c" font-size="8" font-family="sans-serif">Bar Counter / Workstation</text><rect x="70" y="65" width="35" height="15" rx="3" fill="#444"/><rect x="112" y="65" width="35" height="15" rx="3" fill="#444"/><rect x="154" y="65" width="35" height="15" rx="3" fill="#3d1c00"/><circle cx="240" cy="75" r="8" fill="#555" stroke="#666" stroke-width=".5"/><text x="240" y="78" text-anchor="middle" fill="#aaa" font-size="5" font-family="mono">Grinder</text><rect x="60" y="130" width="60" height="30" rx="4" fill="#2d2d44" stroke="#555" stroke-width=".8"/><text x="90" y="148" text-anchor="middle" fill="#c9a84c" font-size="7" font-family="sans-serif">POS</text><path d="M70 130L70 120" stroke="#c9a84c" stroke-width=".8" opacity=".4"/><polygon points="70,118 73,124 67,124" fill="#c9a84c" opacity=".4"/><text x="110" y="123" fill="#aaa" font-size="6" font-family="sans-serif" opacity=".5">Queue</text><circle cx="320" cy="120" r="20" fill="none" stroke="#555" stroke-width=".5" opacity=".5"/><circle cx="320" cy="120" r="10" fill="#333" opacity=".3"/><circle cx="420" cy="120" r="20" fill="none" stroke="#555" stroke-width=".5" opacity=".5"/><circle cx="420" cy="120" r="10" fill="#333" opacity=".3"/><circle cx="480" cy="200" r="20" fill="none" stroke="#555" stroke-width=".5" opacity=".5"/><circle cx="480" cy="200" r="10" fill="#333" opacity=".3"/><circle cx="380" cy="240" r="20" fill="none" stroke="#555" stroke-width=".5" opacity=".5"/><circle cx="380" cy="240" r="10" fill="#333" opacity=".3"/><circle cx="280" cy="200" r="20" fill="none" stroke="#555" stroke-width=".5" opacity=".5"/><circle cx="280" cy="200" r="10" fill="#333" opacity=".3"/><rect x="60" y="230" width="160" height="50" rx="4" fill="#1a1a28" stroke="#444" stroke-width=".5" opacity=".5"/><text x="140" y="250" text-anchor="middle" fill="#888" font-size="7" font-family="sans-serif">Storage / Prep</text><rect x="60" y="200" width="60" height="25" rx="3" fill="#1a1a28" stroke="#444" stroke-width=".5" opacity=".4"/><text x="90" y="215" text-anchor="middle" fill="#888" font-size="6" font-family="sans-serif">Sink</text><rect x="40" y="280" width="4" height="20" fill="#555"/><text x="300" y="340" text-anchor="middle" fill="#c9a84c" font-size="9" opacity=".4" font-family="serif">تصميم المقهى</text></svg>`;
...
<div class="img-c"><img src="${bgSVG('#0d2818','#0d1a0d','🌱')}" alt=""><div class="cap">🌱 حزام البن العالمي — بين مداري السرطان والجدي</div></div>
...
<div class="img-c"><img src="${bgSVG('#0d2818','#0d1a0d','🌱')}" alt=""><div class="cap">🌱 The Coffee Bean Belt — Between the Tropics</div></div>
<h3>🍒 2. Harvesting</h3>
...
<div class="img-c"><img src="${bgSVG('#1a3a1a','#1a1a2e','🐐')}" alt=""><div class="cap">🐐 أسطورة كلد — أول من اكتشف القهوة في مرتفعات إثيوبيا</div></div>
...
<div class="img-c"><img src="${bgSVG('#1a3a1a','#1a1a2e','🐐')}" alt=""><div class="cap">🐐 The Legend of Kaldi — the first discovery of coffee in the Ethiopian highlands</div></div>
...
<div class="img-c"><img src="${bgSVG('#1a3a1a','#1a1a2e','🌱')}" alt=""><div class="cap">🌱 أنواع البن الرئيسية — أرابيكا وروبوستا</div></div>
...
<div class="img-c"><img src="${bgSVG('#1a3a1a','#1a1a2e','🌱')}" alt=""><div class="cap">🌱 Main Coffee Species — Arabica & Robusta</div></div>
...
<div class="img-c"><img src="${svg('map')}" alt=""><div class="cap">🌍 رحلة البن من إثيوبيا إلى العالم</div></div>
<div class="img-c"><img src="${bgSVG('#2d1b00','#1a1a2e','🌍')}" alt=""><div class="cap">🌍 انتشار القهوة من إثيوبيا إلى العالم</div></div>
...
<div class="img-c"><img src="${svg('map')}" alt=""><div class="cap">🌍 Coffee's Journey from Ethiopia to the World</div></div>
<div class="img-c"><img src="${bgSVG('#2d1b00','#1a1a2e','🌍')}" alt=""><div class="cap">🌍 Coffee's Spread from Ethiopia Across the World</div></div>
...
<div class="img-c"><img src="${svg('cherry')}" alt=""><div class="cap">🔬 تشريح ثمرة القهوة — 5 طبقات من البذرة إلى القشرة</div></div>
<div class="img-c"><img src="${bgSVG('#3d1c00','#1a1a2e','🔬')}" alt=""><div class="cap">🔬 تشريح حبة القهوة — من البذرة إلى المشروب</div></div>
...
<div class="img-c"><img src="${svg('cherry')}" alt=""><div class="cap">🔬 Coffee Cherry Anatomy — 5 Layers from Seed to Skin</div></div>
<div class="img-c"><img src="${bgSVG('#3d1c00','#1a1a2e','🔬')}" alt=""><div class="cap">🔬 Coffee Bean Anatomy — From Seed to Cup</div></div>
...
<div class="img-c"><img src="${svg('tdsMeter')}" alt=""><div class="cap">📊 قياس TDS — مفتاح الاتساق والجودة</div></div>
<div class="img-c"><img src="${bgSVG('#1a2e2e','#1a1a2e','⚗️')}" alt=""><div class="cap">⚗️ علم الاستخلاص — كيف تنتقل النكهات من البن إلى الماء</div></div>
...
<div class="img-c"><img src="${svg('tdsMeter')}" alt=""><div class="cap">📊 TDS Measurement — Key to Consistency & Quality</div></div>
<div class="img-c"><img src="${bgSVG('#1a2e2e','#1a1a2e','⚗️')}" alt=""><div class="cap">⚗️ Extraction Science — How Flavors Move from Bean to Water</div></div>
...
<div class="img-c"><img src="${bgSVG('#2d2d44','#1a1a2e','🧰')}" alt=""><div class="cap">🧰 معدات القهوة — من V60 إلى الإسبريسو</div></div>
...
<div class="img-c"><img src="${bgSVG('#2d2d44','#1a1a2e','🧰')}" alt=""><div class="cap">🧰 Coffee Equipment — From V60 to Espresso</div></div>
...
<div class="img-c"><img src="${svg('V60')}" alt=""><div class="cap">🛠️ تحضير V60 خطوة بخطوة — من الغليان إلى التقديم</div></div>
<div class="img-c"><img src="${bgSVG('#1a2e1a','#1a1a2e','🛠️')}" alt=""><div class="cap">🛠️ تحضير V60 — خطوة بخطوة</div></div>
...
<div class="img-c"><img src="${svg('V60')}" alt=""><div class="cap">🛠️ V60 Step by Step — From Boil to Serve</div></div>
<div class="img-c"><img src="${bgSVG('#1a2e1a','#1a1a2e','🛠️')}" alt=""><div class="cap">🛠️ V60 Brewing — Step by Step Guide</div></div>
...
<div class="img-c"><img src="${svg('espressoShot')}" alt=""><div class="cap">☕ الإسبريسو — 9 بار، 92°م، 30 ثانية</div></div>
<div class="img-c"><img src="${bgSVG('#2d1b00','#1a1a2e','☕')}" alt=""><div class="cap">☕ الإسبريسو — قلب عالم القهوة</div></div>
...
<div class="img-c"><img src="${svg('espressoShot')}" alt=""><div class="cap">☕ Espresso — 9 bar, 92°C, 30 seconds</div></div>
<div class="img-c"><img src="${bgSVG('#2d1b00','#1a1a2e','☕')}" alt=""><div class="cap">☕ Espresso — The Heart of the Coffee World</div></div>
...
<div class="img-c"><img src="${svg('latteArt')}" alt=""><div class="cap">🎨 أساسيات اللاتيه أرت — قلب، روزيتا، توليب</div></div>
...
<div class="ok-box"><strong>🎯 تمرين عملي:</strong> ابدأ بتسخين 200 مل حليب في إبريق. حاول عمل رغوة ناعمة بدون فقاعات. عندما تنجح، ارسم قلباً بسيطاً على سطح اللاتيه. كرر 20 مرة قبل الانتقال للشكل التالي.</div>`, en:`<h3>🥛 Latte — The Art of Milk</h3><p>The latte is the <strong>world's most popular espresso drink</strong>. Its composition is simple: espresso + steamed milk + light foam. But the magic lies in <strong>how the ingredients merge</strong> together.</p>
<div class="img-c"><img src="${svg('latteArt')}" alt=""><div class="cap">🎨 Latte Art Basics — Heart, Rosetta, Tulip</div></div>
...
<div class="img-c"><img src="${svg('roastCycle')}" alt=""><div class="cap">🔥 دورة التحميص — من الأخضر إلى الذهبي</div></div>
<div class="img-c"><img src="${bgSVG('#3d1c00','#1a1a2e','🔥')}" alt=""><div class="cap">🔥 تحول حبة البن تحت الحرارة — الكيمياء خلف النكهة</div></div>
...
<div class="img-c"><img src="${svg('roastCycle')}" alt=""><div class="cap">🔥 Roasting Cycle — From Green to Golden</div></div>
<div class="img-c"><img src="${bgSVG('#3d1c00','#1a1a2e','🔥')}" alt=""><div class="cap">🔥 The Bean's Transformation Under Heat — The Chemistry Behind Flavor</div></div>
...
<div class="img-c"><img src="${bgSVG('#0d1a2e','#1a1a2e','💧')}" alt=""><div class="cap">💧 الماء — المكوّن الرئيسي في فنجانك</div></div>
...
<div class="img-c"><img src="${bgSVG('#0d1a2e','#1a1a2e','💧')}" alt=""><div class="cap">💧 Water — The Main Ingredient in Your Cup</div></div>
...
<div class="img-c"><img src="${svg('waterFilter')}" alt=""><div class="cap">💧 مراحل تنقية الماء — من الصنبور إلى الفنجان</div></div>
...
<div class="img-c"><img src="${svg('waterFilter')}" alt=""><div class="cap">💧 Water Purification — From Tap to Cup</div></div>
...
<div class="img-c"><img src="${bgSVG('#1a2e2e','#1a1a2e','⚙️')}" alt=""><div class="cap">⚙️ توزيع حجم الطحن — مفتاح الاستخلاص المتساوي</div></div>
...
<div class="img-c"><img src="${bgSVG('#1a2e2e','#1a1a2e','⚙️')}" alt=""><div class="cap">⚙️ Particle Size Distribution — Key to Even Extraction</div></div>
...
<div class="img-c"><img src="${svg('cuppingSetup')}" alt=""><div class="cap">🧪 محطة الكبينج — تقييم احترافي للقهوة</div></div>
<div class="img-c"><img src="${bgSVG('#2e1a2e','#1a1a2e','🧪')}" alt=""><div class="cap">🧪 التقييم الحسي — فن تذوق القهوة</div></div>
...
<div class="img-c"><img src="${svg('cuppingSetup')}" alt=""><div class="cap">🧪 Cupping Station — Professional Coffee Evaluation</div></div>
<div class="img-c"><img src="${bgSVG('#2e1a2e','#1a1a2e','🧪')}" alt=""><div class="cap">🧪 Sensory Evaluation — The Art of Coffee Tasting</div></div>
...
<div class="img-c"><img src="${bgSVG('#1a3a1a','#1a1a2e','🫘')}" alt=""><div class="cap">🫘 المعالجة الطبيعية — أبسط طرق تحضير البن</div></div>
...
<div class="img-c"><img src="${bgSVG('#1a3a1a','#1a1a2e','🫘')}" alt=""><div class="cap">🫘 Natural Processing — The Simplest Coffee Preparation Method</div></div>
...
<div class="img-c"><img src="${svg('cafeLayout')}" alt=""><div class="cap">🏪 تصميم المقهى — تخطيط المساحة والعمل</div></div>
...
<div class="img-c"><img src="${svg('cafeLayout')}" alt=""><div class="cap">🏪 Cafe Design — Space & Workflow Planning</div></div>
...
<div class="img-c"><img src="${svg('V60')}" alt=""><div class="cap">🧊 التحضير البارد — نكهة مختلفة، طريقة مختلفة</div></div>
...
<div class="img-c"><img src="${svg('V60')}" alt=""><div class="cap">🧊 Cold Brew — Different Method, Different Flavor</div></div>
...
<div class="img-c"><img src="${svg('espressoShot')}" alt=""><div class="cap">🔧 صيانة آلة الإسبريسو — يومية، أسبوعية، شهرية</div></div>
...
<div class="img-c"><img src="${svg('espressoShot')}" alt=""><div class="cap">🔧 Espresso Machine Maintenance — Daily, Weekly, Monthly</div></div>
...
<div class="img-c"><img src="${svg('roastCycle')}" alt=""><div class="cap">🏭 معدات التحميص — من المحمصة اليدوية إلى التجارية</div></div>
...
<div class="img-c"><img src="${svg('roastCycle')}" alt=""><div class="cap">🏭 Roasting Equipment — From Hand to Commercial</div></div>
...
<div class="img-c"><img src="${svg('waterFilter')}" alt=""><div class="cap">📊 عسر الماء — تأثيره على الاستخلاص والنكهة</div></div>
...
<div class="img-c"><img src="${svg('waterFilter')}" alt=""><div class="cap">📊 Water Hardness — Its Effect on Extraction & Flavor</div></div>
...
<div class="img-c"><img src="${svg('tdsMeter')}" alt=""><div class="cap">🏭 تحضير الكميات — الاتساق في الإنتاج الكبير</div></div>
...
<div class="img-c"><img src="${svg('tdsMeter')}" alt=""><div class="cap">🏭 Batch Brew — Consistency in Volume Production</div></div>
...
<div class="img-c"><img src="${svg('cuppingSetup')}" alt=""><div class="cap">👃 تدريب الحواس — كيف تصبح خبير تذوق</div></div>
...
<div class="img-c"><img src="${svg('cuppingSetup')}" alt=""><div class="cap">👃 Sensory Training — How to Become a Tasting Expert</div></div>
...
(function(){
  ...
  setTimeout(()=>{initTilt();initMagnetic()},800);
  setTimeout(()=>{AI.init()},1200);
})();
