...
const LOCAL_IMGS=new Set(['A0','A1','A2','A3','aerial','aroma','barista','barista_work','beans','beans_tree','blossom','brew','cafe','cherry','chemex','coffee_bags','coffee_shop','coldbrew','cup','cupping','espresso','ethiopian','ethiopian_ceremony','farm','filter','fresh_roast','grinder','harvest','journey','kaldy','kaldy_monk','lab','latte','map','mecca_cafe','moka','ottoman_cafe','plantation','processing','roast','roastery','sustainability','team','turkish','turkish_cup','turkish_delight','v60','water']);
...
<div class="img-c"><img src="${photo('farm')}" alt=""><div class="cap">🌱 حزام البن العالمي — بين مداري السرطان والجدي</div></div>
...
<div class="img-c"><img src="${photo('farm')}" alt=""><div class="cap">🌱 The Coffee Bean Belt — Between the Tropics</div></div>
<h3>🍒 2. Harvesting</h3>
...
<div class="img-c"><img src="${photo('kaldy_monk')}" alt=""><div class="cap">🐐 أسطورة كلد — أول من اكتشف القهوة في مرتفعات إثيوبيا</div></div>
...
<div class="img-c"><img src="${photo('kaldy_monk')}" alt=""><div class="cap">🐐 The Legend of Kaldi — the first discovery of coffee in the Ethiopian highlands</div></div>
...
<div class="img-c"><img src="${photo('farm')}" alt=""><div class="cap">🌱 أنواع البن الرئيسية — أرابيكا وروبوستا</div></div>
...
<div class="img-c"><img src="${photo('farm')}" alt=""><div class="cap">🌱 Main Coffee Species — Arabica & Robusta</div></div>
...
<div class="img-c"><img src="${photo('map')}" alt=""><div class="cap">🌍 انتشار القهوة من إثيوبيا إلى العالم</div></div>
...
<div class="img-c"><img src="${photo('map')}" alt=""><div class="cap">🌍 Coffee's Spread from Ethiopia Across the World</div></div>
...
<div class="img-c"><img src="${photo('cherry')}" alt=""><div class="cap">🔬 تشريح حبة القهوة — من البذرة إلى المشروب</div></div>
...
<div class="img-c"><img src="${photo('cherry')}" alt=""><div class="cap">🔬 Coffee Bean Anatomy — From Seed to Cup</div></div>
...
<div class="img-c"><img src="${photo('v60')}" alt=""><div class="cap">⚗️ علم الاستخلاص — كيف تنتقل النكهات من البن إلى الماء</div></div>
...
<div class="img-c"><img src="${photo('v60')}" alt=""><div class="cap">⚗️ Extraction Science — How Flavors Move from Bean to Water</div></div>
...
<div class="img-c"><img src="${photo('barista')}" alt=""><div class="cap">🧰 معدات القهوة — من V60 إلى الإسبريسو</div></div>
...
<div class="img-c"><img src="${photo('barista')}" alt=""><div class="cap">🧰 Coffee Equipment — From V60 to Espresso</div></div>
...
<div class="img-c"><img src="${photo('v60')}" alt=""><div class="cap">🛠️ تحضير V60 — خطوة بخطوة</div></div>
...
<div class="img-c"><img src="${photo('v60')}" alt=""><div class="cap">🛠️ V60 Brewing — Step by Step Guide</div></div>
...
<div class="img-c"><img src="${photo('espresso')}" alt=""><div class="cap">☕ الإسبريسو — قلب عالم القهوة</div></div>
...
<div class="img-c"><img src="${photo('espresso')}" alt=""><div class="cap">☕ Espresso — The Heart of the Coffee World</div></div>
...
<div class="img-c"><img src="${photo('roast')}" alt=""><div class="cap">🔥 تحول حبة البن تحت الحرارة — الكيمياء خلف النكهة</div></div>
...
<div class="img-c"><img src="${photo('roast')}" alt=""><div class="cap">🔥 The Bean's Transformation Under Heat — The Chemistry Behind Flavor</div></div>
...
<div class="img-c"><img src="${photo('water')}" alt=""><div class="cap">💧 الماء — المكوّن الرئيسي في فنجانك</div></div>
...
<div class="img-c"><img src="${photo('water')}" alt=""><div class="cap">💧 Water — The Main Ingredient in Your Cup</div></div>
...
<div class="img-c"><img src="${photo('beans')}" alt=""><div class="cap">⚙️ توزيع حجم الطحن — مفتاح الاستخلاص المتساوي</div></div>
...
<div class="img-c"><img src="${photo('beans')}" alt=""><div class="cap">⚙️ Particle Size Distribution — Key to Even Extraction</div></div>
...
<div class="img-c"><img src="${photo('cupping')}" alt=""><div class="cap">🧪 التقييم الحسي — فن تذوق القهوة</div></div>
...
<div class="img-c"><img src="${photo('cupping')}" alt=""><div class="cap">🧪 Sensory Evaluation — The Art of Coffee Tasting</div></div>
...
<div class="img-c"><img src="${photo('beans_tree')}" alt=""><div class="cap">🫘 المعالجة الطبيعية — أبسط طرق تحضير البن</div></div>
...
<div class="img-c"><img src="${photo('beans_tree')}" alt=""><div class="cap">🫘 Natural Processing — The Simplest Coffee Preparation Method</div></div>
