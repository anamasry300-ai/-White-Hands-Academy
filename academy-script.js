...
<div class="img-c"><img src="${photo('map')}" alt="" loading="lazy"> loading="lazy"<div class="cap">🌍 انتشار القهوة من إثيوبيا إلى العالم</div></div>
...
<div class="img-c"><img src="${photo('map')}" alt="" loading="lazy"> loading="lazy"<div class="cap">🌍 Coffee's Spread from Ethiopia Across the World</div></div>
...
<div class="img-c"><img src="${photo('cherry')}" alt="" loading="lazy"> loading="lazy"<div class="cap">🔬 تشريح حبة القهوة — من البذرة إلى المشروب</div></div>
...
<div class="img-c"><img src="${photo('cherry')}" alt="" loading="lazy"> loading="lazy"<div class="cap">🔬 Coffee Bean Anatomy — From Seed to Cup</div></div>
...
<div class="img-c"><img src="${photo('v60')}" alt="" loading="lazy"> loading="lazy"<div class="cap">⚗️ علم الاستخلاص — كيف تنتقل النكهات من البن إلى الماء</div></div>
...
<div class="img-c"><img src="${photo('v60')}" alt="" loading="lazy"> loading="lazy"<div class="cap">⚗️ Extraction Science — How Flavors Move from Bean to Water</div></div>
...
<div class="img-c"><img src="${photo('barista')}" alt="" loading="lazy"> loading="lazy"<div class="cap">🧰 معدات القهوة — من V60 إلى الإسبريسو</div></div>
...
<div class="img-c"><img src="${photo('barista')}" alt="" loading="lazy"> loading="lazy"<div class="cap">🧰 Coffee Equipment — From V60 to Espresso</div></div>
...
<div class="img-c"><img src="${photo('v60')}" alt="" loading="lazy"> loading="lazy"<div class="cap">🛠️ تحضير V60 — خطوة بخطوة</div></div>
...
<div class="img-c"><img src="${photo('v60')}" alt="" loading="lazy"> loading="lazy"<div class="cap">🛠️ V60 Brewing — Step by Step Guide</div></div>
...
<div class="img-c"><img src="${photo('espresso')}" alt="" loading="lazy"> loading="lazy"<div class="cap">☕ الإسبريسو — قلب عالم القهوة</div></div>
...
<div class="img-c"><img src="${photo('espresso')}" alt="" loading="lazy"> loading="lazy"<div class="cap">☕ Espresso — The Heart of the Coffee World</div></div>
...
<div class="img-c"><img src="${photo('roast')}" alt="" loading="lazy"> loading="lazy"<div class="cap">🔥 تحول حبة البن تحت الحرارة — الكيمياء خلف النكهة</div></div>
...
<div class="img-c"><img src="${photo('roast')}" alt="" loading="lazy"> loading="lazy"<div class="cap">🔥 The Bean's Transformation Under Heat — The Chemistry Behind Flavor</div></div>
...
<div class="img-c"><img src="${photo('water')}" alt="" loading="lazy"> loading="lazy"<div class="cap">💧 الماء — المكوّن الرئيسي في فنجانك</div></div>
...
<div class="img-c"><img src="${photo('water')}" alt="" loading="lazy"> loading="lazy"<div class="cap">💧 Water — The Main Ingredient in Your Cup</div></div>
...
<div class="img-c"><img src="${photo('beans')}" alt="" loading="lazy"> loading="lazy"<div class="cap">⚙️ توزيع حجم الطحن — مفتاح الاستخلاص المتساوي</div></div>
...
<div class="img-c"><img src="${photo('beans')}" alt="" loading="lazy"> loading="lazy"<div class="cap">⚙️ Particle Size Distribution — Key to Even Extraction</div></div>
...
<div class="img-c"><img src="${photo('cupping')}" alt="" loading="lazy"> loading="lazy"<div class="cap">🧪 التقييم الحسي — فن تذوق القهوة</div></div>
...
<div class="img-c"><img src="${photo('cupping')}" alt="" loading="lazy"> loading="lazy"<div class="cap">🧪 Sensory Evaluation — The Art of Coffee Tasting</div></div>
...
<div class="img-c"><img src="${photo('beans_tree')}" alt="" loading="lazy"> loading="lazy"<div class="cap">🫘 المعالجة الطبيعية — أبسط طرق تحضير البن</div></div>
...
<div class="img-c"><img src="${photo('beans_tree')}" alt="" loading="lazy"> loading="lazy"<div class="cap">🫘 Natural Processing — The Simplest Coffee Preparation Method</div></div>
